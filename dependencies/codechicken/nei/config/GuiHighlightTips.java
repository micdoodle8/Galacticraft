...
public class GuiHighlightTips extends GuiScreenWidget
{
    ...
    {
        toggleButton.text = translateG("nei.options." + name + "." + (show() ? "show" : "hide"));
    }
    ...
    public void keyTyped(char c, int keycode)
    {
        ...
        {
            GuiInfo.switchGui(opt.slot.getGui());
            return;
        }
    ...
    public void drawScreen(int mousex, int mousey, float f)
    {
        ...
        if(show())
            HUDRenderer.renderOverlay(new ItemStack(Block.blockRedstone), Arrays.asList("RedstoneBlock", "\247cSample"), renderPos());
    }
    ...
    public Point getDrag()
    {
        ...
        drag.x*=10000; drag.y*=10000;
        drag.x/=(size.width-sample.width); drag.y/=(size.height-sample.height);
        Point pos = getPos();
