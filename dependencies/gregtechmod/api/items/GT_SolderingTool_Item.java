...
public class GT_SolderingTool_Item extends GT_Tool_Item {
	public GT_SolderingTool_Item(int aID, String aName, int aMaxDamage, int aEntityDamage, int aDischargedGTID) {
		...
		GT_OreDictUnificator.registerOre("craftingToolSolderingIron", new ItemStack(itemID, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
		GregTech_API.registerSolderingTool(new ItemStack(itemID, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
