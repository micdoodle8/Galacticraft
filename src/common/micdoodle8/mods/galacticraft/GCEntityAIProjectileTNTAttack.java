 ...
 *
 */
public class GCEntityAIProjectileTNTAttack extends EntityAIBase
{
    World worldObj;
    ...
    public GCEntityAIProjectileTNTAttack(EntityLiving par1EntityLiving, float movementSpeed, int rangedAttackID, int waitBeforeRefire)
    {
    ...
    private void doRangedAttack()
    {
        if (this.rangedAttackID == 1)
        {
        	...
        	GCEntityProjectileTNT var17 = new GCEntityProjectileTNT(this.entityHost.worldObj, this.entityHost, var11, var13, var15);
            double var18 = 4.0D;
