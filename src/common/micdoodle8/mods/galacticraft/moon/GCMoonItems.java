...
public class GCMoonItems 
{
	...
	{
		cheeseCurd = new GCMoonItem(GCMoonConfigManager.idItemCheeseCurd).setIconIndex(0).setItemName("cheeseCurd");
		...
		meteoricIronRaw = new GCMoonItem(GCMoonConfigManager.idItemMeteoricIronRaw).setIconIndex(2).setItemName("meteoricIron");
	}
