 ...
 *
 */
public class GCMarsEntityProjectileTNT extends Entity
{
	private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public GCMarsEntityProjectileTNT(World par1World, EntityLiving par2EntityLiving, double par3, double par5, double par7)
    {
        super(par1World);
