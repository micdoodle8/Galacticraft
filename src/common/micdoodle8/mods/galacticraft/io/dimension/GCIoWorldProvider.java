package micdoodle8.mods.galacticraft.io.dimension;

import micdoodle8.mods.galacticraft.API.IGalacticraftWorldProvider;
import micdoodle8.mods.galacticraft.io.GCIoConfigManager;
import micdoodle8.mods.galacticraft.io.wgen.GCIoChunkProvider;
import micdoodle8.mods.galacticraft.io.wgen.GCIoWorldChunkManager;
...
public class GCIoWorldProvider extends WorldProvider implements IGalacticraftWorldProvider
{
	...
	public GCIoWorldProvider()
    {
        this.setDimension(GCIoConfigManager.dimensionIDIo);
        this.dimensionId = GCIoConfigManager.dimensionIDIo;
    }
    ...
    {
        this.worldChunkMgr = new GCIoWorldChunkManager(this.worldObj, 0F);
    }
...
//        return var3 == GCMarsBlocks.marsGrass.blockID;
    ...
    {
    	return "DIM" + GCIoConfigManager.dimensionIDIo;
    }
