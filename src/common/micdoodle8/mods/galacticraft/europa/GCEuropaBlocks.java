...
public class GCEuropaBlocks 
{
	...
	{	
		brittleIce = 										new GCEuropaBrittleIce				(GCEuropaConfigManager.idBlockBrittleIce, 					0)						.setHardness(1.7F)																				.setCreativeTab(GalacticraftCore.galacticraftTab)																.setBlockName("brittleIce");
	}
