...
public class GCEuropaWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCEuropaWorldChunkManager()
    {
    ...
    public GCEuropaWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCEuropaWorldChunkManager(World par1World, float par2)
    {
