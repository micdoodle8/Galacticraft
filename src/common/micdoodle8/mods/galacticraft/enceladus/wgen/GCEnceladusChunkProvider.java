...
public class GCEnceladusChunkProvider extends ChunkProviderGenerate
{
	...
	public GCEnceladusBiomeDecorator biomedecoratorplanet = new GCEnceladusBiomeDecorator(GCEnceladusBiomeGenBase.enceladusFlat);
	...
	private BiomeGenBase[] biomesForGeneration = {GCEnceladusBiomeGenBase.enceladusFlat};
	...
	public GCEnceladusChunkProvider(World par1World, long par2, boolean par4)
	{
	...
	{
		short topBlockID = (short) Block.stone.blockID;
		byte topBlockMeta = 0;
		short fillBlockID = (short) Block.dirt.blockID;
		...
		for (int var8 = 0; var8 < 16; ++var8)
		{
			for (int var9 = 0; var9 < 16; ++var9) 
			{
				...
				byte var14m = topBlockMeta;
				short var15 = fillBlockID;
				byte var15m = fillBlockMeta;

				for (int var16 = 127; var16 >= 0; --var16) 
				{
					int index = (var9 * 16 + var8) * 128 + var16;
					arrayOfMeta[index] = 0;
	...
	public Chunk provideChunk(int par1, int par2)
	{
		...
		Chunk var4 = new GCCoreChunk(this.worldObj, (int[])ids, (int[])meta, par1, par2);
