 ...
 *
 */
public class GCEntityCreeperBoss extends EntityMob
{
    ...
    public GCEntityCreeperBoss(World par1World)
    {
        super(par1World);
        this.texture = "/micdoodle8/mods/galacticraft/client/entities/creeper.png";
...
//        this.tasks.addTask(4, new EntityAIAttackOnCollide(this, 0.25F, false));
        this.tasks.addTask(4, new GCEntityAIProjectileTNTAttack(this, this.moveSpeed, 1, 60));
        ...
        if (!this.worldObj.isRemote && this.timeSinceTNTFired == 0)
    	{
            ...
            for (int var12 = 0; var12 < this.worldObj.playerEntities.size(); ++var12)
            {
                ...
                if (!var13.capabilities.isCreativeMode)
                {
                    ...
                    {
                        GCUtil.createNewExplosion(worldObj, this, this.posX, this.posY, this.posZ, 12.0F, true);
