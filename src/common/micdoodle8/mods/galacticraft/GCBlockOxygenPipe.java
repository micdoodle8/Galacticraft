...
public class GCBlockOxygenPipe extends BlockContainer
{
	...
	public void addCollidingBlockToList(World world, int i, int j, int k, AxisAlignedBB axisalignedbb, List arraylist, Entity par7Entity) 
	{
		...
		if (world.getBlockId(i - 1, j, k) == this.blockID || world.getBlockId(i - 1, j, k) == GCBlocks.airDistributor.blockID || world.getBlockId(i - 1, j, k) == GCBlocks.airDistributorActive.blockID)
		{
		...
		if (world.getBlockId(i, j - 1, k) == this.blockID || world.getBlockId(i, j - 1, k) == GCBlocks.airDistributor.blockID || world.getBlockId(i, j - 1, k) == GCBlocks.airDistributorActive.blockID)
		{
		...
		if (world.getBlockId(i, j, k - 1) == this.blockID || world.getBlockId(i, j, k - 1) == GCBlocks.airDistributor.blockID || world.getBlockId(i, j, k - 1) == GCBlocks.airDistributorActive.blockID)
		{
