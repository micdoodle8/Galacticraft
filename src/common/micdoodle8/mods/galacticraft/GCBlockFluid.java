 ...
 *
 */
public abstract class GCBlockFluid extends Block
{
    protected GCBlockFluid(int par1, int par2, Material par2Material)
    {
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            double var10 = (double)0 / 255.0D;
            double var5 = (double)128 / 255.0D;
            double var7 = (double)0 / 255.0D;
    ...
    public static double getFlowDirection(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, Material par4Material)
    {
        ...
        if (par4Material == GCBlocks.bacterialSludge)
        {
            var5 = ((GCBlockFluid)GCBlocks.bacterialSludgeMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }
    ...
    private void checkForHarden(World par1World, int par2, int par3, int par4)
    {
    	if (par1World.getBlockMaterial(par2, par3, par4 - 1) == Material.water)
    	{
            ...
            par1World.setBlockAndMetadataWithNotify(par2, par3, par4 - 1, GCBlocks.bacterialSludgeMoving.blockID, var6);
    	}
    	...
    	if (par1World.getBlockMaterial(par2 - 1, par3, par4) == Material.water)
    	{
            ...
            par1World.setBlockAndMetadataWithNotify(par2 - 1, par3, par4, GCBlocks.bacterialSludgeMoving.blockID, var6);
    	}
    	...
    	if (par1World.getBlockMaterial(par2, par3 - 1, par4) == Material.water)
    	{
            ...
            par1World.setBlockAndMetadataWithNotify(par2, par3 - 1, par4, GCBlocks.bacterialSludgeMoving.blockID, var6);
    	}
