 ...
 *
 */
public class GCWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCWorldChunkManager()
    {
        ...
        this.biomesToSpawnIn.add(GCBiomeGenBase.marsFlat);
    }
    ...
    public GCWorldChunkManager(World par1World)
    {
    ...
    {
        return GCBiomeGenBase.marsFlat;
    }
