                    ...
                    for (var42 = caveMinX; !isBlockWater && var42 < caveMaxX; ++var42)
                    {
                        for (int var43 = caveMinZ; !isBlockWater && var43 < caveMaxZ; ++var43)
                        {
                            for (int var44 = caveMaxY + 1; !isBlockWater && var44 >= caveMinY - 1; --var44)
                            {
                                ...
                                {
                                    if (par5ArrayOfByte[var45] == (byte)GCBlocks.bacterialSludgeMoving.blockID || par5ArrayOfByte[var45] == (byte)GCBlocks.bacterialSludgeStill.blockID)
                                    {
                                        isBlockWater = true;
                                    }
                            ...
                            if (var59 * var59 + var46 * var46 < 1.0D)
                            {
                                for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
                                {
                                    ...
                                    if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                    {
                                        ...
                                        if (var53 == (byte) GCBlocks.marsGrass.blockID)
                                        {
                                            var49 = true;
                                        }

                                        if (var53 == (byte)GCBlocks.marsStone.blockID || var53 == (byte)GCBlocks.marsDirt.blockID || var53 == (byte)GCBlocks.marsGrass.blockID)
                                        {
                                            if (isBlockWater)
                                            {
                                                par5ArrayOfByte[var48] = (byte) GCBlocks.bacterialSludgeStill.blockID;
                                            }
                                            else
                                            {
                                                par5ArrayOfByte[var48] = 0;

                                                if (var49 && par5ArrayOfByte[var48 - 1] == (byte) GCBlocks.marsDirt.blockID)
                                                {
                                                    par5ArrayOfByte[var48 - 1] = (byte) GCBlocks.marsGrass.blockID;
                                                }
                                            }
                                        }
                                    }
