...
public class GCEntitySludgeling extends EntityMob
{
    private int allySummonCooldown;

    public GCEntitySludgeling(World par1World)
    {
        super(par1World);
        this.texture = "/micdoodle8/mods/galacticraft/client/entities/sludgeling.png";
