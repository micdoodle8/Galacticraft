...
public class GCItemReinforcedBucket extends GCItem
{
	public int isFull;
	
    public GCItemReinforcedBucket(int par1, int par2)
    {
        super(par1);
        this.maxStackSize = 1;
        this.isFull = par2;
    ...
    {
    	if (this.shiftedIndex != GCItems.reinforcedBucketMilk.shiftedIndex)
    	{
        ...
        return par1ItemStack.stackSize <= 0 ? new ItemStack(GCItems.reinforcedBucketEmpty) : par1ItemStack;
    }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
    	if (this.shiftedIndex != GCItems.reinforcedBucketMilk.shiftedIndex)
    	{
            ...
            else
            {
                ...
                if (var12.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    if (this.isFull == 0)
                    {
                        ...
                        if (par2World.getBlockMaterial(var13, var14, var15) == Material.water && par2World.getBlockMetadata(var13, var14, var15) == 0)
                        {
                            ...
                            if (--par1ItemStack.stackSize <= 0)
                            {
                                return new ItemStack(GCItems.reinforcedBucketWater);
                            }

                            if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(GCItems.reinforcedBucketWater)))
                            {
                                par3EntityPlayer.dropPlayerItem(new ItemStack(GCItems.reinforcedBucketWater.shiftedIndex, 1, 0));
                            }
                        ...
                        if (par2World.getBlockMaterial(var13, var14, var15) == Material.lava && par2World.getBlockMetadata(var13, var14, var15) == 0)
                        {
                            ...
                            if (--par1ItemStack.stackSize <= 0)
                            {
                                return new ItemStack(GCItems.reinforcedBucketLava);
                            }

                            if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(GCItems.reinforcedBucketLava)))
                            {
                                par3EntityPlayer.dropPlayerItem(new ItemStack(GCItems.reinforcedBucketLava.shiftedIndex, 1, 0));
                            }

                            return par1ItemStack;
                        }

                        if (par2World.getBlockMaterial(var13, var14, var15) == GCBlocks.bacterialSludge && par2World.getBlockMetadata(var13, var14, var15) == 0)
                        {
                            par2World.setBlockWithNotify(var13, var14, var15, 0);
                            ...
                            if (--par1ItemStack.stackSize <= 0)
                            {
                                return new ItemStack(GCItems.reinforcedBucketBacteria);
                            }

                            if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(GCItems.reinforcedBucketBacteria)))
                            {
                                par3EntityPlayer.dropPlayerItem(new ItemStack(GCItems.reinforcedBucketBacteria.shiftedIndex, 1, 0));
                            }
                    ...
                    else
                    {
                        if (this.isFull < 0)
                        {
                            return new ItemStack(GCItems.reinforcedBucketEmpty);
                        }
                ...
                {
                    return new ItemStack(GCItems.reinforcedBucketMilk);
                }
