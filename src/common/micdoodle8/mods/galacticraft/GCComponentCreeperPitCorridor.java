 ...
 *
 */
public class GCComponentCreeperPitCorridor extends GCStructureComponent
{
    private int height;
    private int width;
    private int length;
    
	public GCComponentCreeperPitCorridor(int type, int x, int y, int z, int height, int width, int length, int cbm)
	{
        super(type);
