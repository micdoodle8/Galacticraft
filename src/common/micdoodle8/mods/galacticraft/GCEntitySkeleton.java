...
public class GCEntitySkeleton extends EntityMob
{
    ...
    public GCEntitySkeleton(World par1World)
    {
        super(par1World);
        this.texture = "/micdoodle8/mods/galacticraft/client/entities/skeleton.png";
        this.moveSpeed = 0.25F;
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, new EntityAIRestrictSun(this));
        this.tasks.addTask(3, new EntityAIFleeSun(this, this.moveSpeed));
        this.tasks.addTask(4, new GCEntityAIArrowAttack(this, this.moveSpeed, 1, 20));
