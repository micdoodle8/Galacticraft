...
public class GCChunkProvider extends ChunkProviderGenerate implements IChunkProvider 
{
	...
	private GCCaveGen caveGenerator = new GCCaveGen();
	private GCCaveGen2 caveGenerator2 = new GCCaveGen2();
	...
	private BiomeGenBase[] biomesForGeneration = {GCBiomeGenBase.marsFlat};
					...
					for (int var31 = 0; var31 < 8; ++var31) 
					{
						...
						for (int var42 = 0; var42 < 4; ++var42) 
						{
							...
							for (int var51 = 0; var51 < 4; ++var51)
							{
								if ((var47 += var49) > 0.0D) 
								{
									par3ArrayOfByte[var43 += var44] = (byte) GCConfigManager.idBlockMarsStone;
								}
	...
	public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
	{
		...
		for (int var8 = 0; var8 < 16; ++var8)
		{
			for (int var9 = 0; var9 < 16; ++var9) 
			{
				...
				int var13 = -1;
				byte var14 = (byte) GCConfigManager.idBlockMarsGrass;
				byte var15 = (byte) GCConfigManager.idBlockMarsDirt;
				...
				for (int var16 = 127; var16 >= 0; --var16) 
				{
					...
					} else 
					{
						...
						else if (var18 == (byte) GCConfigManager.idBlockMarsStone)
						{
							if (var13 == -1)
							{
								if (var12 <= 0)
								{
									var14 = 0;
									var15 = (byte) GCConfigManager.idBlockMarsStone;
								} 
								else if (var16 >= var5 - -16 && var16 <= var5 + 1)
								{
									var14 = (byte) GCConfigManager.idBlockMarsGrass;
									var15 = (byte) GCConfigManager.idBlockMarsDirt;
								}
