 ...
 *
 */
public class GCEntityAIArrowAttack extends EntityAIBase
{
    World worldObj;
    ...
    public GCEntityAIArrowAttack(EntityLiving par1EntityLiving, float par2, int par3, int par4)
    {
        this.entityHost = par1EntityLiving;
        this.worldObj = par1EntityLiving.worldObj;
        this.entityMoveSpeed = par2;
        this.rangedAttackID = par3;
        if (par4 == 20 && this.worldObj.provider instanceof GCWorldProvider)
        {
    ...
    private void doRangedAttack()
    {
        if (this.rangedAttackID == 1)
        {
        	...
        	if (this.worldObj.provider instanceof GCWorldProvider)
        	{
        		var1 = new GCEntityArrow(this.worldObj, this.entityHost, this.attackTarget, 0.3F, 12.0F);
        	}
        	else
        	{
