...
public class GCBlocks 
{
	...
	public static void initBlocks() 
	{
		...
		unlitTorch = (GCBlockUnlitTorch) 					new GCBlockUnlitTorch 			(GCConfigManager.idBlockUnlitTorch,             	37, false)					.setHardness(0.0F)								.setLightValue(0.2F)							.setCreativeTab(null)								.setStepSound(Block.soundWoodFootstep)					.setBlockName("unlitTorch");
		unlitTorchLit = (GCBlockUnlitTorch) 				new GCBlockUnlitTorch 			(GCConfigManager.idBlockUnlitTorchLit,             	37, true)				.setHardness(0.0F)								.setLightValue(0.9375F)							.setCreativeTab(null)								.setStepSound(Block.soundWoodFootstep)					.setBlockName("unlitTorchLit");
