 ...
 *
 */
public class GCBlockTreasureChest extends BlockContainer
{
    private Random random = new Random();

    protected GCBlockTreasureChest(int par1)
    {
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        GCTileEntityTreasureChest var6 = (GCTileEntityTreasureChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        GCTileEntityTreasureChest var7 = (GCTileEntityTreasureChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object var10 = (GCTileEntityTreasureChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (GCTileEntityTreasureChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)var10);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (IInventory)var10, (GCTileEntityTreasureChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (GCTileEntityTreasureChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)var10);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (IInventory)var10, (GCTileEntityTreasureChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
        return new GCTileEntityTreasureChest();
    }
