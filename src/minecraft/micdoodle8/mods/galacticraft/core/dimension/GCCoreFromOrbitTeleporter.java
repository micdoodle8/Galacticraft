 ...
 *
 */
public class GCCoreFromOrbitTeleporter extends Teleporter
{
	private final Random random;
    private final WorldServer worldServer;
    private boolean usePlayerBaseCoords;

	public GCCoreFromOrbitTeleporter(WorldServer par1WorldServer, boolean usePlayerBaseCoords)
	{
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
    	if (par1Entity instanceof GCCorePlayerBase)
    	{
            ...
            final int var9 = MathHelper.floor_double(playerBase.coordsTeleportedFromX);
            final int var11 = MathHelper.floor_double(playerBase.coordsTeleportedFromZ);
