...
public class GCCoreModelTreasureChest extends ModelChest
{
    public NMTModelRenderer keyParts[] = new NMTModelRenderer[6];
    
	public GCCoreModelTreasureChest()
	{
		super();
	    textureWidth = 64;
	    textureHeight = 64;
		...
		keyParts[5] = (NMTModelRenderer) (new NMTModelRenderer(this, 0, 0)).setTextureSize(64, 64);
