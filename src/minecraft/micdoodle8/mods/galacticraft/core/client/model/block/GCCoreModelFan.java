...
public class GCCoreModelFan extends ModelBase
{
	...
	public GCCoreModelFan(float par1)
	{
		...
		this.setRotation(center, 0F, 0F, 0F);
		...
		this.setRotation(fans[0][0], 0F, 0F, 0F);
		...
		this.setRotation(fans[0][1], 0F, 0F, 0F);
		...
		this.setRotation(fans[0][2], 0F, 0F, 0F);
		...
		this.setRotation(fans[1][0], 0F, 0F, 0F);
		...
		this.setRotation(fans[1][1], 0F, 0F, 0F);
		...
		this.setRotation(fans[1][2], 0F, 0F, 0F);
		...
		this.setRotation(fans[2][0], 0F, 0F, 0F);
		...
		this.setRotation(fans[2][1], 0F, 0F, 0F);
		...
		this.setRotation(fans[2][2], 0F, 0F, 0F);
		...
		this.setRotation(fans[3][0], 0F, 0F, 0F);
		...
		this.setRotation(fans[3][1], 0F, 0F, 0F);
		...
		this.setRotation(fans[3][2], 0F, 0F, 0F);
	}
