...
public class GCCoreModelWorm extends ModelBase
{
	...
	public GCCoreModelWorm(float f)
	{
		...
		body[6] = new ModelRenderer(this, 152, 28);
		body[6].addBox(-5F, -5F, -122F, 10, 10, 16);
		body[6].setRotationPoint(0F, 16F, -66F);
		body[6].setTextureSize(256, 128);
		body[6].mirror = true;
		setRotation(body[6], 3.141593F, 0F, -0.6981317F);
		body[5] = new ModelRenderer(this, 152, 0);
		body[5].addBox(-6F, -6F, -106F, 12, 12, 16);
		body[5].setRotationPoint(0F, 16F, -66F);
		body[5].setTextureSize(256, 128);
		body[5].mirror = true;
		setRotation(body[5], 3.141593F, 0F, -0.3490659F);
		body[4] = new ModelRenderer(this, 88, 96);
		body[4].addBox(-8F, -8F, -90F, 16, 16, 16);
		body[4].setRotationPoint(0F, 16F, -66F);
		body[4].setTextureSize(256, 128);
		body[4].mirror = true;
		setRotation(body[4], 3.141593F, 0F, 0F);
		body[2] = new ModelRenderer(this, 88, 32);
		body[2].addBox(-8F, -8F, -58F, 16, 16, 16);
		body[2].setRotationPoint(0F, 16F, -66F);
		body[2].setTextureSize(256, 128);
		body[2].mirror = true;
		setRotation(body[2], 3.141593F, 0F, 0.6981317F);
		body[1] = new ModelRenderer(this, 88, 0);
		body[1].addBox(-8F, -8F, -42F, 16, 16, 16);
		body[1].setRotationPoint(0F, 16F, -66F);
		body[1].setTextureSize(256, 128);
		body[1].mirror = true;
		setRotation(body[1], 3.141593F, 0F, 1.047198F);
		body[0] = new ModelRenderer(this, 0, 0);
		body[0].addBox(-8F, -8F, -26F, 16, 16, 16);
		body[0].setRotationPoint(0F, 16F, -66F);
		body[0].setTextureSize(256, 128);
		body[0].mirror = true;
		setRotation(body[0], 3.141593F, 0F, 1.396263F);
		head = new ModelRenderer(this, 0, 32);
		head.addBox(-8F, -8F, -10F, 16, 16, 16);
		head.setRotationPoint(0F, 16F, -66F);
		head.setTextureSize(256, 128);
		head.mirror = true;
		setRotation(head, 3.141593F, 0F, 0F);
		pincers[0][0] = new ModelRenderer(this, 64, 24);
		pincers[0][0].addBox(-0.5F, -15F, 9F, 1, 1, 3);
		pincers[0][0].setRotationPoint(0F, 16F, -65F);
		pincers[0][0].setTextureSize(256, 128);
		pincers[0][0].mirror = true;
		setRotation(pincers[0][0], 3.141593F, 0F, 0F);
		pincers[3][3] = new ModelRenderer(this, 64, 0);
		pincers[3][3].addBox(-1F, -11F, -4F, 2, 3, 10);
		pincers[3][3].setRotationPoint(0F, 16F, -65F);
		pincers[3][3].setTextureSize(256, 128);
		pincers[3][3].mirror = true;
		setRotation(pincers[3][3], 3.141593F, 0F, 1.570796F);
		pincers[2][3] = new ModelRenderer(this, 64, 13);
		pincers[2][3].addBox(-0.5F, -14F, 4F, 1, 3, 3);
		pincers[2][3].setRotationPoint(0F, 16F, -65F);
		pincers[2][3].setTextureSize(256, 128);
		pincers[2][3].mirror = true;
		setRotation(pincers[2][3], 3.141593F, 0F, 1.570796F);
		pincers[1][3] = new ModelRenderer(this, 64, 19);
		pincers[1][3].addBox(-0.5F, -15F, 6F, 1, 2, 3);
		pincers[1][3].setRotationPoint(0F, 16F, -65F);
		pincers[1][3].setTextureSize(256, 128);
		pincers[1][3].mirror = true;
		setRotation(pincers[1][3], 3.141593F, 0F, 1.570796F);
		pincers[3][1] = new ModelRenderer(this, 64, 0);
		pincers[3][1].addBox(-1F, -11F, -4F, 2, 3, 10);
		pincers[3][1].setRotationPoint(0F, 16F, -65F);
		pincers[3][1].setTextureSize(256, 128);
		pincers[3][1].mirror = true;
		setRotation(pincers[3][1], 3.141593F, 0F, 4.712389F);
		pincers[2][1] = new ModelRenderer(this, 64, 13);
		pincers[2][1].addBox(-0.5F, -14F, 4F, 1, 3, 3);
		pincers[2][1].setRotationPoint(0F, 16F, -65F);
		pincers[2][1].setTextureSize(256, 128);
		pincers[2][1].mirror = true;
		setRotation(pincers[2][1], 3.141593F, 0F, 4.712389F);
		pincers[1][1] = new ModelRenderer(this, 64, 19);
		pincers[1][1].addBox(-0.5F, -15F, 6F, 1, 2, 3);
		pincers[1][1].setRotationPoint(0F, 16F, -65F);
		pincers[1][1].setTextureSize(256, 128);
		pincers[1][1].mirror = true;
		setRotation(pincers[1][1], 3.141593F, 0F, 4.712389F);
		pincers[0][1] = new ModelRenderer(this, 64, 24);
		pincers[0][1].addBox(-0.5F, -15F, 9F, 1, 1, 3);
		pincers[0][1].setRotationPoint(0F, 16F, -65F);
		pincers[0][1].setTextureSize(256, 128);
		pincers[0][1].mirror = true;
		setRotation(pincers[0][1], 3.141593F, 0F, 4.712389F);
		pincers[3][2] = new ModelRenderer(this, 64, 0);
		pincers[3][2].addBox(-1F, -11F, -4F, 2, 3, 10);
		pincers[3][2].setRotationPoint(0F, 16F, -65F);
		pincers[3][2].setTextureSize(256, 128);
		pincers[3][2].mirror = true;
		setRotation(pincers[3][2], 3.141593F, 0F, 3.141593F);
		pincers[2][2] = new ModelRenderer(this, 64, 13);
		pincers[2][2].addBox(-0.5F, -14F, 4F, 1, 3, 3);
		pincers[2][2].setRotationPoint(0F, 16F, -65F);
		pincers[2][2].setTextureSize(256, 128);
		pincers[2][2].mirror = true;
		setRotation(pincers[2][2], 3.141593F, 0F, 3.141593F);
		pincers[1][2] = new ModelRenderer(this, 64, 19);
		pincers[1][2].addBox(-0.5F, -15F, 6F, 1, 2, 3);
		pincers[1][2].setRotationPoint(0F, 16F, -65F);
		pincers[1][2].setTextureSize(256, 128);
		pincers[1][2].mirror = true;
		setRotation(pincers[1][2], 3.141593F, 0F, 3.141593F);
		pincers[0][2] = new ModelRenderer(this, 64, 24);
		pincers[0][2].addBox(-0.5F, -15F, 9F, 1, 1, 3);
		pincers[0][2].setRotationPoint(0F, 16F, -65F);
		pincers[0][2].setTextureSize(256, 128);
		pincers[0][2].mirror = true;
		setRotation(pincers[0][2], 3.141593F, 0F, 3.141593F);
		pincers[3][0] = new ModelRenderer(this, 64, 0);
		pincers[3][0].addBox(-1F, -11F, -4F, 2, 3, 10);
		pincers[3][0].setRotationPoint(0F, 16F, -65F);
		pincers[3][0].setTextureSize(256, 128);
		pincers[3][0].mirror = true;
		setRotation(pincers[3][0], 3.141593F, 0F, 0F);
		pincers[2][0] = new ModelRenderer(this, 64, 13);
		pincers[2][0].addBox(-0.5F, -14F, 4F, 1, 3, 3);
		pincers[2][0].setRotationPoint(0F, 16F, -65F);
		pincers[2][0].setTextureSize(256, 128);
		pincers[2][0].mirror = true;
		setRotation(pincers[2][0], 3.141593F, 0F, 0F);
		pincers[1][0] = new ModelRenderer(this, 64, 19);
		pincers[1][0].addBox(-0.5F, -15F, 6F, 1, 2, 3);
		pincers[1][0].setRotationPoint(0F, 16F, -65F);
		pincers[1][0].setTextureSize(256, 128);
		pincers[1][0].mirror = true;
		setRotation(pincers[1][0], 3.141593F, 0F, 0F);
		pincers[0][3] = new ModelRenderer(this, 64, 24);
		pincers[0][3].addBox(-0.5F, -15F, 9F, 1, 1, 3);
		pincers[0][3].setRotationPoint(0F, 16F, -65F);
		pincers[0][3].setTextureSize(256, 128);
		pincers[0][3].mirror = true;
		setRotation(pincers[0][3], 3.141593F, 0F, 1.570796F);
		body[3] = new ModelRenderer(this, 88, 64);
		body[3].addBox(-8F, -8F, -74F, 16, 16, 16);
		body[3].setRotationPoint(0F, 16F, -66F);
		body[3].setTextureSize(256, 128);
		body[3].mirror = true;
		setRotation(body[3], 3.141593F, 0F, 0.3490659F);
		body[7] = new ModelRenderer(this, 152, 54);
		body[7].addBox(-4F, -4F, -154F, 6, 6, 16);
		body[7].setRotationPoint(0F, 16F, -66F);
		body[7].setTextureSize(256, 128);
		body[7].mirror = true;
		setRotation(body[7], 3.141593F, 0F, -1.396263F);
		body[8] = new ModelRenderer(this, 152, 78);
		body[8].addBox(-4F, -4F, -138F, 8, 8, 16);
		body[8].setRotationPoint(0F, 16F, -66F);
		body[8].setTextureSize(256, 128);
		body[8].mirror = true;
		setRotation(body[8], 3.141593F, 0F, -1.047198F);
