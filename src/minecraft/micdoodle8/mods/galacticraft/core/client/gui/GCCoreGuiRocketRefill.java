...
public class GCCoreGuiRocketRefill extends GuiContainer
{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        {
        	ItemStack stack = ((GCCoreEntitySpaceship) this.mc.thePlayer.ridingEntity).getStackInSlot(0);
        	
        	if (stack != null)
        	{
        		float fuelLevel = ((stack.getMaxDamage() - stack.getItemDamage()) / (((float)stack.getMaxDamage()) - 1.0F)) * 1000.0F;
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        if (this.mc.thePlayer != null && this.mc.thePlayer.ridingEntity != null && this.mc.thePlayer.ridingEntity instanceof GCCoreEntitySpaceship)
        {
        	...
        	if (stack != null)
        	{
        		int fuelLevel = (stack.getMaxDamage() - stack.getItemDamage());
