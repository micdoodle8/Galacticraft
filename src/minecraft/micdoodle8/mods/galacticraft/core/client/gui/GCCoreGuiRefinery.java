...
{
    private final GCCoreTileEntityRefinery refineryInventory;
    ...
    {
        final int var4 = this.mc.renderEngine.getTexture("/micdoodle8/mods/galacticraft/core/client/gui/refinery.png");
