...
public class GCCoreOverlaySensorGlasses extends GCCoreOverlay
{
	...
	public static void renderSensorGlassesMain()
	{
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, GCCoreOverlaySensorGlasses.minecraft.renderEngine.getTexture("/micdoodle8/mods/galacticraft/core/client/gui/hud.png"));
        ...
        while (var51.hasNext())
        {
            ...
            try
            {
                ...
                if (var20 < 4.0D)
                {
    				...
    				GL11.glBindTexture(GL11.GL_TEXTURE_2D, GCCoreOverlaySensorGlasses.minecraft.renderEngine.getTexture("/micdoodle8/mods/galacticraft/core/client/gui/indicator.png"));
