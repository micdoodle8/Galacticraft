 ...
 *
 */
public class GCCallistoWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCCallistoWorldChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(GCCallistoBiomeGenBase.callistoFlat);
    }

    public GCCallistoWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCCallistoWorldChunkManager(World par1World, float par2)
    {
    ...
    {
        return GCCallistoBiomeGenBase.callistoFlat;
    }
