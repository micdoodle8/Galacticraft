...
import micdoodle8.mods.galacticraft.callisto.blocks.GCCallistoBlock;
 ...
 *
 */
public class GCCallistoChunkProvider extends ChunkProviderGenerate
{
	...
	public GCCallistoBiomeDecorator biomedecoratorplanet = new GCCallistoBiomeDecorator(GCCallistoBiomeGenBase.callistoFlat);
	...
	private BiomeGenBase[] biomesForGeneration = {GCCallistoBiomeGenBase.callistoFlat};
	...
	public GCCallistoChunkProvider(World par1World, long par2, boolean par4)
	{
		...
		GCCallistoChunkProvider.giantCaveLocations = new ArrayList();
		GCCallistoChunkProvider.creeperDungeonLocations = new ArrayList();
	}

	public void replaceBlocksForBiome(int par1, int par2, int[] arrayOfIDs, int[] arrayOfMeta, BiomeGenBase[] par4ArrayOfBiomeGenBase)
	{
		final int topBlockID = GCCallistoBlocks.block.blockID;
		final int topBlockMeta = 0;
		final int fillBlockID = GCCallistoBlocks.block.blockID;
		final int fillBlockMeta = 1;
		final int lowerBlockID = GCCallistoBlocks.block.blockID;
			...
			for (int var9 = 0; var9 < 16; ++var9) 
			{
				...
				for (int var16 = 127; var16 >= 0; --var16) 
				{
					...
					else 
					{
						...
						else if (var18 == GCCallistoBlocks.block.blockID)
						{
							arrayOfMeta[index] = 2;
                    ...
                    for (int var31 = 0; var31 < 8; ++var31)
                    {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42)
                        {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51)
                            {
                                if ((var47 += var49) > 0.0D)
                                {
                                	idArray[var43 += var44] = GCCallistoBlocks.block.blockID;
                                	metaArray[var43] = 2;
                                }
