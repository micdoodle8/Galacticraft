 ...
 *
 */
public class GCTitanWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCTitanWorldChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(GCTitanBiomeGenBase.titanFlat);
    }

    public GCTitanWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCTitanWorldChunkManager(World par1World, float par2)
    {
    ...
    {
        return GCTitanBiomeGenBase.titanFlat;
    }
