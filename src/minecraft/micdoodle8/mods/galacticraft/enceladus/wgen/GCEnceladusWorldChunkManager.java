 ...
 *
 */
public class GCEnceladusWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCEnceladusWorldChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(GCEnceladusBiomeGenBase.enceladusFlat);
    }

    public GCEnceladusWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCEnceladusWorldChunkManager(World par1World, float par2)
    {
    ...
    {
        return GCEnceladusBiomeGenBase.enceladusFlat;
    }
