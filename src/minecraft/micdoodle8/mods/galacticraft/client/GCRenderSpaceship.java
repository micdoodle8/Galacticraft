...
public class GCRenderSpaceship extends Render
{
    /** instance of ModelMinecart for rendering */
    protected ModelBase modelSpaceship;

    public GCRenderSpaceship()
    {
        this.shadowSize = 2F;
        this.modelSpaceship = new GCModelSpaceship();
    }

    public void renderSpaceship(GCEntitySpaceship par1GCEntitySpaceship, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
        ...
        this.loadTexture("/micdoodle8/mods/galacticraft/client/entities/spaceship1.png");
    ...
    {
        this.renderSpaceship((GCEntitySpaceship)par1Entity, par2, par4, par6, par8, par9);
    }
}
