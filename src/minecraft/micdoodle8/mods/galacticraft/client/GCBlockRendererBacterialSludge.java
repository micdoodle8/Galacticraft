...
import micdoodle8.mods.galacticraft.GCBlockFluid;
 ...
 *
 */
public class GCBlockRendererBacterialSludge implements ISimpleBlockRenderingHandler
{
    final int renderID;

    public GCBlockRendererBacterialSludge(int var1)
    {
        this.renderID = var1;
    }
...
//            if (this.renderAllFaces || var10)
            {
                ...
                float var35 = (float)GCBlockFluid.getFlowDirection(var1, par2, par3, par4, var22);
    ...
    public static float getFluidHeight(IBlockAccess var1, int par1, int par2, int par3, Material par4Material)
    {
        ...
        for (int var7 = 0; var7 < 4; ++var7)
        {
            ...
            if (var11 == par4Material)
            {
                ...
                if (var12 >= 8 || var12 == 0)
                {
                    var6 += GCBlockFluid.getFluidHeightPercent(var12) * 10.0F;
                    var5 += 10;
                }

                var6 += GCBlockFluid.getFluidHeightPercent(var12);
                ++var5;
            }
