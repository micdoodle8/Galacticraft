...
import micdoodle8.mods.galacticraft.*;
...
public class GCTileEntityTreasureChestRenderer extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderGCTileEntityTreasureChestAt(GCTileEntityTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        else
        {
            ...
            {
                ((GCBlockTreasureChest)var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
                var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
            }
    ...
    {
        this.renderGCTileEntityTreasureChestAt((GCTileEntityTreasureChest)par1TileEntity, par2, par4, par6, par8);
    }
}
