 ...
 *
 */
public class GCSkyProvider extends SkyProvider 
{
	public int starGLCallList = GLAllocation.generateDisplayLists(3); 
	public int glSkyList;
	public int glSkyList2;
	
	public GCSkyProvider() 
	{
		GL11.glPushMatrix();
	...
	{
		GCWorldProvider gcProvider = null;
		
		if (world.provider instanceof GCWorldProvider)
		{
			gcProvider = (GCWorldProvider)world.provider;
		}
        ...
        if (gcProvider != null)
        {
            ...
            GL11.glScalef(0.6F, 0.6F, 0.6F);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 5F);
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTexture("/micdoodle8/mods/galacticraft/client/planets/phobos.png"));
	        ...
	        GL11.glScalef(0.6F, 0.6F, 0.6F);
	        GL11.glColor4f(1.0F, 1.0F, 1.0F, 5F);
	        GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTexture("/micdoodle8/mods/galacticraft/client/planets/deimos.png"));
    ...
    {
        return Vec3.getVec3Pool().getVecFromPool(0.26796875D, 0.1796875D, 0.0D);
    }
