...
import micdoodle8.mods.galacticraft.GCBlockUnlitTorch;
 ...
 *
 */
public class GCBlockRendererUnlitTorch implements ISimpleBlockRenderingHandler
{
    final int renderID;

    public GCBlockRendererUnlitTorch(int var1)
    {
        this.renderID = var1;
    }
    ...
    {
    	if (par1Block instanceof GCBlockUnlitTorch)
    	{
    		GCBlockUnlitTorch block = (GCBlockUnlitTorch) par1Block;
