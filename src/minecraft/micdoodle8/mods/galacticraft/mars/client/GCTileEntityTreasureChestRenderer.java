...
public class GCTileEntityTreasureChestRenderer extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderGCTileEntityTreasureChestAt(GCMarsTileEntityTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
    {
        int var9;
    ...
    {
        this.renderGCTileEntityTreasureChestAt((GCMarsTileEntityTreasureChest)par1TileEntity, par2, par4, par6, par8);
    }
}
