...
public class GCRenderArrow extends Render
{
    public void renderArrow(GCEntityArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderArrow((GCEntityArrow)par1Entity, par2, par4, par6, par8, par9);
    }
}
