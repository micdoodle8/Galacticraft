 ...
 *
 */
public class ClientProxyMimas extends CommonProxyMimas implements IGalacticraftSubModClient
{
	...
	public void init(FMLInitializationEvent event)
	{
        ...
        NetworkRegistry.instance().registerChannel(new ClientPacketHandler(), "GcMim", Side.CLIENT);
        GalacticraftCore.proxy.addSlotRenderer(new GCMimasSlotRenderer());
	}

	@Override
	public void postInit(FMLPostInitializationEvent event)
	{
		GCMimasBlocks.addNames();
//		GCTitanItems.addNames(); TODO
    ...
    public static class TickHandlerClient implements ITickHandler
    {
        ...
        {
    		ClientProxyMimas.getCurrentTime = System.currentTimeMillis();
            ...
            {
    			if (world != null && world.provider instanceof GCMimasWorldProvider)
    			{
    				if (world.provider.getSkyRenderer() == null)
                    {
    					world.provider.setSkyRenderer(new GCMimasSkyProvider());
                    }
    			}
            }
        }
        ...
        {
            return "Galacticraft Mimas Client";
        }
