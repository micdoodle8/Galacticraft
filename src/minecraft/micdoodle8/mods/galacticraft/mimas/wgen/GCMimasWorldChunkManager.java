 ...
 *
 */
public class GCMimasWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCMimasWorldChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(GCMimasBiomeGenBase.mimasFlat);
    }

    public GCMimasWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCMimasWorldChunkManager(World par1World, float par2)
    {
    ...
    {
        return GCMimasBiomeGenBase.mimasFlat;
    }
