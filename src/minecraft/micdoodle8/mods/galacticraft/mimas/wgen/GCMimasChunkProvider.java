 ...
 *
 */
public class GCMimasChunkProvider extends ChunkProviderGenerate
{
	...
	public GCMimasBiomeDecorator biomedecoratorplanet = new GCMimasBiomeDecorator(GCMimasBiomeGenBase.mimasFlat);
	...
	private BiomeGenBase[] biomesForGeneration = {GCMimasBiomeGenBase.mimasFlat};
	...
	public GCMimasChunkProvider(World par1World, long par2, boolean par4)
	{
		...
		GCMimasChunkProvider.giantCaveLocations = new ArrayList();
		GCMimasChunkProvider.creeperDungeonLocations = new ArrayList();
	}

	public void replaceBlocksForBiome(int par1, int par2, int[] arrayOfIDs, int[] arrayOfMeta, BiomeGenBase[] par4ArrayOfBiomeGenBase)
	{
		final int topBlockID = GCMimasBlocks.block.blockID;
		final int topBlockMeta = 0;
		final int fillBlockID = GCMimasBlocks.block.blockID;
