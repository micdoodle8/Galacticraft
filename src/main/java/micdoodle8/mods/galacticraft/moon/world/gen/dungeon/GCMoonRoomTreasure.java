...
public class GCMoonRoomTreasure extends GCCoreDungeonRoom
{
	...
	public void generate(Block[] chunk, byte[] meta, int cx, int cz)
	{
		...
		if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, GCCoreBlocks.treasureChestTier1, 0))
		{
	...
	protected void handleTileEntities(Random rand)
	{
		if (!this.chests.isEmpty())
		{
			...
			{
				this.worldObj.setBlock(coords.posX, coords.posY, coords.posZ, GCCoreBlocks.treasureChestTier1, 0, 3);
				this.worldObj.setTileEntity(coords.posX, coords.posY, coords.posZ, new GCCoreTileEntityTreasureChest(1));
