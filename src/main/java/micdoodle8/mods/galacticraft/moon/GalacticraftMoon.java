...
public class GalacticraftMoon
{
	...
	{
		GalacticraftMoon.galacticraftMoonTab = new GCCoreCreativeTab(CreativeTabs.getNextID(), GalacticraftMoon.MODID, Item.getItemFromBlock(GCCoreBlocks.blockMoon), 5);
