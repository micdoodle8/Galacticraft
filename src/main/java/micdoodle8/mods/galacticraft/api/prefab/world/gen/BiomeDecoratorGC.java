 ...
 */
public abstract class BiomeDecoratorGC
{
	...
	public void decorate(World world, Random random, int chunkX, int chunkZ)
	{
		...
		else
		{
			...
			this.chunkX = chunkX;
			this.chunkZ = chunkZ;
			MinecraftForge.EVENT_BUS.post(new EventWorldPopulate.Pre(this.currentWorld, this.rand, this.chunkX, this.chunkZ));
			this.decorate();
			MinecraftForge.EVENT_BUS.post(new EventWorldPopulate.Post(this.currentWorld, this.rand, this.chunkX, this.chunkZ));
