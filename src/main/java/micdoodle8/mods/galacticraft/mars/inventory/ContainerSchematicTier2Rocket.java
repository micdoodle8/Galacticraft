...
import micdoodle8.mods.galacticraft.core.inventory.SlotSchematicResult;
...
{
	public InventoryRocketBenchT2 craftMatrix = new InventoryRocketBenchT2(this);
	...
	public ContainerSchematicTier2Rocket(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
	{
		...
		this.addSlotToContainer(new SlotSchematicResult(par1InventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 142, 18 + 69 + change));
		int var6;
		int var7;
	...
	{
		this.craftResult.setInventorySlotContents(0, MarsUtil.findMatchingSpaceshipT2Recipe(this.craftMatrix));
	}
