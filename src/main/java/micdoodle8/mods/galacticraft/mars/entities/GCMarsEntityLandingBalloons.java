 ...
 * 
 */
public class GCMarsEntityLandingBalloons extends GCMarsEntityAdvancedMotion implements IInventorySettable, IPacketReceiver, IScaleableFuelLevel
{
	...
	public GCMarsEntityLandingBalloons(GCEntityPlayerMP player)
	{
