 ...
 * 
 */
public abstract class GCMarsEntityAdvancedMotion extends InventoryEntity implements IPacketReceiver, IControllableEntity
{
	...
	public GCMarsEntityAdvancedMotion(World world, double initialSpeed, float yOffset)
	{
		super(world);
	...
	public GCMarsEntityAdvancedMotion(World world, double initialSpeed, float yOffset, double var2, double var4, double var6)
	{
