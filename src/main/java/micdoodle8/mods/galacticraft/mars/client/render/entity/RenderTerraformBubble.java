...
import micdoodle8.mods.galacticraft.core.client.model.ModelOxygenBubble;
...
public class RenderTerraformBubble extends Render
{
	...
	private final ModelOxygenBubble bubbleModel = new ModelOxygenBubble();

	@Override
	protected ResourceLocation getEntityTexture(Entity par1Entity)
	{
		return RenderTerraformBubble.bubbleTexture;
	}
	...
	public void doRender(Entity entity, double d0, double d1, double d2, float f, float f1)
	{
		...
		GL11.glScaled(((EntityTerraformBubble) entity).getSize(), ((EntityTerraformBubble) entity).getSize(), ((EntityTerraformBubble) entity).getSize());
