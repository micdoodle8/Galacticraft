...
import micdoodle8.mods.galacticraft.core.client.gui.container.GuiAdvancedContainer;
...
public class GCMarsGuiCargoRocket extends GuiAdvancedContainer
{
	...
	{
		super(new ContainerRocketFuel(par1IInventory, rocket, rocketType));
	...
	public void initGui()
	{
		...
		this.infoRegions.add(new InfoRegion((this.width - this.xSize) / 2 + (this.rocket.rocketType.getInventorySpace() == 2 ? 70 : 71), (this.height - this.ySize) / 2 + 6, 36, 40, oxygenDesc, this.width, this.height));
	}
