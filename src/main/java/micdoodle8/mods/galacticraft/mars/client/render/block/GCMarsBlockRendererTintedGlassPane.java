...
public class GCMarsBlockRendererTintedGlassPane implements ISimpleBlockRenderingHandler
{
	...
	public void renderGlassPaneInWorld(RenderBlocks renderBlocks, IBlockAccess iblockaccess, Block par1Block, int x, int y, int z)
	{
		...
		this.renderBlockPane(renderBlocks, iblockaccess, (GCMarsBlockTintedGlassPane) par1Block, x, y, z);

		renderBlocks.clearOverrideBlockTexture();
	}

	public boolean renderBlockPane(RenderBlocks renderBlocks, IBlockAccess iblockaccess, GCMarsBlockTintedGlassPane par1BlockPane, int par2, int par3, int par4)
	{
