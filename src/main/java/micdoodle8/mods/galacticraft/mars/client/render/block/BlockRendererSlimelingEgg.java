 ...
 * 
 */
public class BlockRendererSlimelingEgg implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public BlockRendererSlimelingEgg(int var1)
	{
		this.renderID = var1;
	}
	...
	public static void renderInvNormalBlock(RenderBlocks renderBlocks, Block par1Block, int var2)
	{
		...
		BlockRendererSlimelingEgg.renderStandardBlock(renderBlocks, par1Block, var2);
	...
	{
		BlockRendererSlimelingEgg.renderInvNormalBlock(renderer, block, metadata);
	}
