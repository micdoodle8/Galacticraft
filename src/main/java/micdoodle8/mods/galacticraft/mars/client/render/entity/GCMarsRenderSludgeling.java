...
{
	private static final ResourceLocation sludgelingTexture = new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "textures/model/sludgeling.png");
	...
	public void doRender(GCMarsEntitySludgeling sludgeling, double par2, double par4, double par6, float par8, float par9)
	{
	...
	{
		this.doRender((GCMarsEntitySludgeling) par1EntityLiving, par2, par4, par6, par8, par9);
	}

	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
	{
		this.doRender((GCMarsEntitySludgeling) par1Entity, par2, par4, par6, par8, par9);
	}
}
