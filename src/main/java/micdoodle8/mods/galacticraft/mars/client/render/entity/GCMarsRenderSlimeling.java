...
{
	private static final ResourceLocation landerTexture = new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "textures/model/slimeling/green.png");
	...
	protected void passSpecialRender(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6)
	{
		...
		{
			this.renderLivingLabelWithColor(par1EntityLivingBase, ((GCMarsEntitySlimeling) par1EntityLivingBase).getName(), par2, par4 + 0.33, par6, 64, 0, 0, 0);
