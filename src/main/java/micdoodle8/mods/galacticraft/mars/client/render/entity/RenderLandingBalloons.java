...
import micdoodle8.mods.galacticraft.mars.client.model.ModelBalloonParachute;
...
{
	private static final ResourceLocation landerTexture = new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "textures/model/landingBalloon.png");
	...
	{
		this.shadowSize = 2F;
		this.landerModel = AdvancedModelLoader.loadModel(new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "models/landingBalloon.obj"));
	}
