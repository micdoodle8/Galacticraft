...
public class GCMarsEntityDropParticleFX extends EntityFX
{
	...
	public void onUpdate()
	{
		...
		Block var1 = this.worldObj.getBlock(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ));

		if (var1 instanceof IFluidBlock)
		{
			final double var2 = MathHelper.floor_double(this.posY) + 1 - ((IFluidBlock) var1).getFilledPercentage(this.worldObj, MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ));
