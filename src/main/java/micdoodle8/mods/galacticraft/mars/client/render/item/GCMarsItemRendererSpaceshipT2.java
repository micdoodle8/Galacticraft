...
{
	private static final ResourceLocation cargoRocketTexture = new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "textures/model/cargoRocket.png");
	private IModelCustom cargoRocketModel;

	public GCMarsItemRendererSpaceshipT2(IModelCustom cargoRocketModel)
	{
		super(new GCMarsEntityRocketT2(FMLClientHandler.instance().getClient().theWorld), new GCMarsModelSpaceshipTier2(), new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "textures/model/rocketT2.png"));
