...
public class ItemRendererTier2Rocket extends ItemRendererTier1Rocket
{
	...
	{
		super(new EntityTier2Rocket(FMLClientHandler.instance().getClient().theWorld), new ModelTier2Rocket(), new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "textures/model/rocketT2.png"));
