...
public class GCMarsGuiSlimelingInventory extends GuiContainer
{
	...
	public GCMarsGuiSlimelingInventory(EntityPlayer player, EntitySlimeling slimeling)
	{
	...
	public static void drawSlimelingOnGui(GCMarsGuiSlimelingInventory screen, EntitySlimeling slimeling, int par1, int par2, int par3, float par4, float par5)
	{
