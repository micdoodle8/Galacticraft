...
public class GCMarsGuiSlimeling extends GuiScreen
{
	...
	public GCMarsGuiSlimeling(EntitySlimeling slimeling)
	{
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		this.drawString(this.fontRendererObj, this.slimeling.getName() + (this.cursorPulse / 24 % 2 == 0 && this.isTextFocused ? "_" : ""), startX + 4, startY + 4, this.incorrectUseTimer > 0 ? GCCoreUtil.convertTo32BitColor(255, 255, 20, 20) : 0xe0e0e0);
	...
	public static void drawSlimelingOnGui(GCMarsGuiSlimeling screen, EntitySlimeling slimeling, int par1, int par2, int par3, float par4, float par5)
	{
