...
public class GCMarsGuiSlimeling extends GuiScreen
{
	...
	private static final ResourceLocation slimelingPanelGui = new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "textures/gui/slimelingPanel0.png");
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		this.drawString(this.fontRendererObj, str, var5 + this.xSize - 15 - this.fontRendererObj.getStringWidth(str), var6 + 10, CoreUtil.to32BitColor(255, 255, 0, 0));
		str = "" + Math.round(this.slimeling.getColorGreen() * 1000) / 10.0F + "% ";
		this.drawString(this.fontRendererObj, str, var5 + this.xSize - 15 - this.fontRendererObj.getStringWidth(str), var6 + 23, CoreUtil.to32BitColor(255, 0, 255, 0));
		str = "" + Math.round(this.slimeling.getColorBlue() * 1000) / 10.0F + "% ";
		this.drawString(this.fontRendererObj, str, var5 + this.xSize - 15 - this.fontRendererObj.getStringWidth(str), var6 + 36, CoreUtil.to32BitColor(255, 0, 0, 255));
		...
		this.drawString(this.fontRendererObj, this.slimeling.getName() + (this.cursorPulse / 24 % 2 == 0 && this.isTextFocused ? "_" : ""), startX + 4, startY + 4, this.incorrectUseTimer > 0 ? CoreUtil.to32BitColor(255, 255, 20, 20) : 0xe0e0e0);
		...
		GCMarsGuiSlimeling.drawItems.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.renderEngine, new ItemStack(this.slimeling.getFavoriteFood()), dX + var5 + 55 + this.fontRendererObj.getStringWidth(str), dY + var6 + 41 + 14);
