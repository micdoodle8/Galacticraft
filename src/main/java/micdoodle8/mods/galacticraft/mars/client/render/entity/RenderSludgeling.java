...
import micdoodle8.mods.galacticraft.mars.client.model.ModelSludgeling;
...
public class RenderSludgeling extends RenderLiving
{
	...
	{
		this.doRender((EntitySludgeling) par1EntityLiving, par2, par4, par6, par8, par9);
	}

	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
	{
		this.doRender((EntitySludgeling) par1Entity, par2, par4, par6, par8, par9);
	}
}
