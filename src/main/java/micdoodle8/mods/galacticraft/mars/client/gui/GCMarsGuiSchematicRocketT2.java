...
{
	private static final ResourceLocation tier2SchematicTexture = new ResourceLocation(GalacticraftMars.ASSET_DOMAIN, "textures/gui/schematic_rocket_T2.png");
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		this.mc.renderEngine.bindTexture(GCMarsGuiSchematicRocketT2.tier2SchematicTexture);
