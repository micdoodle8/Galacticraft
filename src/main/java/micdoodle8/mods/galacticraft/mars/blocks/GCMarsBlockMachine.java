...
public class GCMarsBlockMachine extends GCCoreBlockTile
{
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
	{
		...
		if (var8 instanceof IChunkLoader && !var8.getWorldObj().isRemote && GCMarsConfigManager.launchControllerChunkLoad && entityLiving instanceof EntityPlayer)
		{
		...
		{
			((GCMarsTileEntityLaunchController) var8).setOwnerName(((EntityPlayer) entityLiving).getGameProfile().getName());
		}
	}
	...
	{
		return new ItemStack(this, 1, GCMarsBlockMachine.TERRAFORMER_METADATA);
	}

	public ItemStack getChamber()
	{
		return new ItemStack(this, 1, GCMarsBlockMachine.CRYOGENIC_CHAMBER_METADATA);
	}

	public ItemStack getLaunchController()
	{
		return new ItemStack(this, 1, GCMarsBlockMachine.LAUNCH_CONTROLLER_METADATA);
	}
