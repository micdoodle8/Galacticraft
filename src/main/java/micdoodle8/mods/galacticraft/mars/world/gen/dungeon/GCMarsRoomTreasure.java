...
public class GCMarsRoomTreasure extends GCCoreDungeonRoom
{
	...
	public void generate(Block[] chunk, byte[] meta, int cx, int cz)
	{
		...
		if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, GCMarsBlocks.tier2TreasureChest, 0))
		{
	...
	protected void handleTileEntities(Random rand)
	{
		if (!this.chests.isEmpty())
		{
			...
			{
				this.worldObj.setBlock(coords.posX, coords.posY, coords.posZ, GCMarsBlocks.tier2TreasureChest, 0, 3);
				this.worldObj.setTileEntity(coords.posX, coords.posY, coords.posZ, new GCMarsTileEntityTreasureChest());
