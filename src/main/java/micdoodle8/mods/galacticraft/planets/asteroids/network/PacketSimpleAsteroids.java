...
//            AsteroidsTickHandlerServer.requestMinerBaseFacingUpdate(player.worldObj.provider.getDimension(), new BlockPos((Integer) this.data.get(0), (Integer) this.data.get(1), (Integer) this.data.get(2)));
            break;
        default:
            break;
        }
