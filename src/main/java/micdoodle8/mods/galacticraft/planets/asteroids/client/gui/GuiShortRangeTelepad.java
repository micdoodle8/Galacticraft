...
public class GuiShortRangeTelepad extends GuiContainerGC implements ITextBoxCallback
{
	...
	public void initGui()
	{
        ...
        batterySlotDesc.add(GCCoreUtil.translate("gui.telepad.desc.0"));
        ...
        batterySlotDesc = new ArrayList<String>();
        batterySlotDesc.add(GCCoreUtil.translate("gui.telepad.desc.1"));
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
        ...
        EnergyHelper.getEnergyDisplayTooltip(this.telepad.getEnergyStoredGC(), this.telepad.getMaxEnergyStoredGC(), electricityDesc);
