...
//
//        //Empty canister
//        if (itemCanister.getDamage() >= itemCanister.getMaxDamage())
//        {
//            return false;
//        }
//
//        //Full tank
//        if (itemTank.getDamage() <= 0)
//        {
//            return false;
//        }
//
...
//        }
//
//        int oxygenAvail = itemCanister.getMaxDamage() - itemCanister.getDamage();
//        int oxygenToFill = itemTank.getDamage() * 5 / 54;
//
...
//            {
//                ItemCanisterLiquidOxygen.saveDamage(itemCanister, itemCanister.getDamage() + oxygenToFill);
//            }
//            return result;
//        }
//
...
//        ItemStack result = itemTank.copy();
//        result.setDamage(tankDamageNew);
//        if (itemCanister.getItem() instanceof ItemCanisterLiquidOxygen)
//        {
