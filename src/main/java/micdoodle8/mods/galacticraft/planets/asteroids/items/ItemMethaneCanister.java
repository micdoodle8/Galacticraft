...
public class ItemMethaneCanister extends Item
{
	protected IIcon[] icons = new IIcon[7];

	public ItemMethaneCanister(String assetName)
	{
		super();
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
	{
		...
		{
			par3List.add("Gas: " + (par1ItemStack.getMaxDamage() - par1ItemStack.getItemDamage()));
		}
	}
