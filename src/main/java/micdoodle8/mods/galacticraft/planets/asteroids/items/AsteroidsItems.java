...
public class AsteroidsItems
{
    ...
    public static ItemArmor.ArmorMaterial ARMOR_TITANIUM = EnumHelper.addArmorMaterial("titanium", "", 26, new int[] { 5, 10, 7, 5 }, 12, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F);
