...
public class GuiSchematicTier3Rocket extends GuiPositionedContainer implements ISchematicResultPage
{
    ...
    public GuiSchematicTier3Rocket(PlayerInventory playerInv, BlockPos pos)
    {
        super(new ContainerSchematicTier3Rocket(playerInv, pos), pos);
        this.ySize = 238;
    }
    ...
    public void initGui()
    {
        super.initGui();
        this.buttons.clear();
        this.buttons.add(new Button(0, this.width / 2 - 130, this.height / 2 - 110, 40, 20, GCCoreUtil.translate("gui.button.back.name")));
        this.buttons.add(new Button(1, this.width / 2 - 130, this.height / 2 - 110 + 25, 40, 20, GCCoreUtil.translate("gui.button.next.name")));
    }
