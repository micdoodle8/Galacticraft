...
public class AsteroidFeatures
{
    ...
    public static final IStructurePieceType CBASE_START = BaseStart::new;
    public static final IStructurePieceType CBASE_ROOM = BaseRoom::new;
    public static final IStructurePieceType CBASE_DECK = BaseDeck::new;
    public static final IStructurePieceType CBASE_PLATE = BasePlate::new;
    public static final IStructurePieceType CBASE_HANGAR = BaseHangar::new;
    public static final IStructurePieceType CBASE_LINKING = BaseLinking::new;
