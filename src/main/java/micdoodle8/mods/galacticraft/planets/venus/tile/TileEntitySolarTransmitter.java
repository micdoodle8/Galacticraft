...
//    }
    ...
    public TileEntity[] getAdjacentConnections()
    {
        ...
        if (this.adjacentConnections == null)
        {
            ...
            {
                TileEntity tileEntity = thisVec.getTileEntityOnSide(this.worldObj, direction);

                if (tileEntity instanceof TileEntitySolarArrayModule)
                {
                    if (this.worldObj.isRemote || ((TileEntitySolarArrayModule) tileEntity).canConnect(direction.getOpposite(), NetworkType.SOLAR_MODULE))
                    {
