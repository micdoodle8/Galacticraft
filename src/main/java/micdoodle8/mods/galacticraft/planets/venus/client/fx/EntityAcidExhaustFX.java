...
public class EntityAcidExhaustFX extends EntityFX
{
    float smokeParticleScale;

    public EntityAcidExhaustFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double motionX, double motionY, double motionZ, float p_i46348_14_)
    {
