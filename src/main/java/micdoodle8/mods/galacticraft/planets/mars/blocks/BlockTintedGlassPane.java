...
public class BlockTintedGlassPane extends BlockPane implements IPartialSealableBlock
{
	...
	{
		return GalacticraftPlanets.proxyMars.getTintedGlassPaneRenderID();
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister)
	{
		...
		for (int i = 0; i < this.iconArray.length; ++i)
		{
			this.iconArray[i] = par1IconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + this.getTextureName() + "_" + ItemDye.field_150921_b[BlockColored.func_150032_b(i)]);
		}
