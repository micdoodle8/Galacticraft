...
public class ModelTier2Rocket extends ModelBase
{
    ...
    RendererModel[][] fins = new RendererModel[4][5];
    // 8 parts to the top of the rocket, last is the long center piece
    RendererModel[] top = new RendererModel[8];
    ...
    public ModelTier2Rocket(float var1)
    {
        ...
        this.inside[0] = new RendererModel(this, 0, 59);
        ...
        this.inside[1] = new RendererModel(this, 0, 78);
        ...
        this.inside[2] = new RendererModel(this, 0, 40);
        ...
        this.fins[0][1] = new RendererModel(this, 66, 0);
        ...
        this.fins[0][2] = new RendererModel(this, 66, 0);
        ...
        this.fins[0][3] = new RendererModel(this, 66, 0);
        ...
        this.fins[0][4] = new RendererModel(this, 66, 0);
        ...
        this.fins[0][0] = new RendererModel(this, 60, 0);
        ...
        this.fins[1][0] = new RendererModel(this, 74, 0);
        ...
        this.fins[1][1] = new RendererModel(this, 66, 0);
        ...
        this.fins[1][2] = new RendererModel(this, 66, 0);
        ...
        this.fins[1][3] = new RendererModel(this, 66, 0);
        ...
        this.fins[1][4] = new RendererModel(this, 66, 0);
        ...
        this.fins[2][0] = new RendererModel(this, 60, 0);
        ...
        this.fins[2][1] = new RendererModel(this, 66, 0);
        ...
        this.fins[2][2] = new RendererModel(this, 66, 0);
        ...
        this.fins[2][3] = new RendererModel(this, 66, 0);
        ...
        this.fins[2][4] = new RendererModel(this, 66, 0);
        ...
        this.fins[3][0] = new RendererModel(this, 74, 0);
        ...
        this.fins[3][1] = new RendererModel(this, 66, 0);
        ...
        this.fins[3][2] = new RendererModel(this, 66, 0);
        ...
        this.fins[3][3] = new RendererModel(this, 66, 0);
        ...
        this.fins[3][4] = new RendererModel(this, 66, 0);
        ...
        this.top[0] = new RendererModel(this, 192, 60);
        ...
        this.top[1] = new RendererModel(this, 200, 78);
        ...
        this.top[2] = new RendererModel(this, 208, 94);
        ...
        this.top[3] = new RendererModel(this, 216, 108);
        ...
        this.top[4] = new RendererModel(this, 224, 120);
        ...
        this.top[5] = new RendererModel(this, 232, 130);
        ...
        this.top[6] = new RendererModel(this, 240, 138);
        ...
        this.top[7] = new RendererModel(this, 248, 144);
        ...
        this.base[0] = new RendererModel(this, 0, 0);
        ...
        this.base[1] = new RendererModel(this, 0, 15);
        ...
        this.base[2] = new RendererModel(this, 0, 28);
        ...
        this.sides[0] = new RendererModel(this, 85, 0);
        ...
        this.sides[1] = new RendererModel(this, 103, 0);
        ...
        this.sides[2] = new RendererModel(this, 85, 18);
        ...
        this.sides[3] = new RendererModel(this, 103, 55);
        ...
        this.sides[4] = new RendererModel(this, 120, 0);
        ...
        this.sides[5] = new RendererModel(this, 120, 141);
        ...
        this.sides[6] = new RendererModel(this, 119, 70);
        ...
        this.boosters[0][0] = new RendererModel(this, 154, 19);
        ...
        this.boosters[0][1] = new RendererModel(this, 154, 6);
        ...
        this.boosters[0][2] = new RendererModel(this, 154, 0);
        ...
        this.boosters[1][0] = new RendererModel(this, 154, 19);
        ...
        this.boosters[1][1] = new RendererModel(this, 154, 6);
        ...
        this.boosters[1][2] = new RendererModel(this, 154, 0);
        ...
        this.boosters[2][0] = new RendererModel(this, 154, 19);
        ...
        this.boosters[2][1] = new RendererModel(this, 154, 6);
        ...
        this.boosters[2][2] = new RendererModel(this, 154, 0);
        ...
        this.boosters[3][0] = new RendererModel(this, 154, 19);
        ...
        this.boosters[3][1] = new RendererModel(this, 154, 6);
        ...
        this.boosters[3][2] = new RendererModel(this, 154, 0);
    ...
    public void render(Entity entity, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        for (final RendererModel model : this.top)
        {
            model.render(par7);
        }

        for (final RendererModel model : this.base)
        {
            model.render(par7);
        }

        for (final RendererModel model : this.sides)
        {
            model.render(par7);
        }
    ...
    private void setStartingAngles(RendererModel model, float x, float y, float z)
    {
