...
public class ItemSchematicMars extends ItemSchematic implements ISchematicItem
{
	...
	{
		for (int i = 0; i < ItemSchematicMars.names.length; i++)
		{
	...
	{
		this.icons = new IIcon[ItemSchematicMars.names.length];

		for (int i = 0; i < ItemSchematicMars.names.length; i++)
		{
			this.icons[i] = iconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + ItemSchematicMars.names[i]);
		}
