...
public class GuiTerraformer extends GuiContainerGC implements ICheckBoxCallback
{
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            {
            case 0:
                GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, mc.theWorld.provider.getDimension(), new Object[] { this.terraformer.getPos(), 0 }));
                break;
            case 1:
                GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, mc.theWorld.provider.getDimension(), new Object[] { this.terraformer.getPos(), 1 }));
                break;
            case 2:
                break;
            default:
    ...
    public void onSelectionChanged(GuiElementCheckbox checkbox, boolean newSelected)
    {
        ...
        GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, mc.theWorld.provider.getDimension(), new Object[] { 6, this.terraformer.getPos(), newSelected ? 1 : 0 }));
    }
