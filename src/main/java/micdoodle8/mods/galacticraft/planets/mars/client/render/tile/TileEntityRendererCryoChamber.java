...
public class TileEntityRendererCryoChamber extends TileEntitySpecialRenderer
{
	private static final ResourceLocation chamberTexture0 = new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/model/chamber_dark.png");
	private static final ResourceLocation chamberTexture1 = new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/model/chamber2_dark.png");

	private final IModelCustom model;

	public TileEntityRendererCryoChamber(IModelCustom model)
	{
		this.model = model;
	}
