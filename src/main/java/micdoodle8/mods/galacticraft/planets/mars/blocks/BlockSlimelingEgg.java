...
public class BlockSlimelingEgg extends Block implements ITileEntityProvider
{
	...
	public void registerBlockIcons(IIconRegister IIconRegister)
	{
		...
		this.IIcons[0] = IIconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "redEgg_0");
		this.IIcons[1] = IIconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "blueEgg_0");
		this.IIcons[2] = IIconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "yellowEgg_0");
		this.IIcons[3] = IIconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "redEgg_1");
		this.IIcons[4] = IIconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "blueEgg_1");
		this.IIcons[5] = IIconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "yellowEgg_1");
	...
	{
		return GalacticraftPlanets.proxyMars.getEggRenderID();
	}
