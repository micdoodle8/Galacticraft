...
public class GuiCargoRocket extends GuiContainerGC
{
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        {
        case 0:
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimpleMars(EnumSimplePacketMars.S_UPDATE_CARGO_ROCKET_STATUS, mc.theWorld.provider.getDimensionId(), new Object[] { this.rocket.getEntityId(), 0 }));
            break;
        default:
            break;
        }
