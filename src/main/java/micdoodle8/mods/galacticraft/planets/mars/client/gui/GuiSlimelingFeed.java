...
public class GuiSlimelingFeed extends GuiScreen
{
	...
	private static final ResourceLocation slimelingPanelGui = new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/gui/slimelingPanel1.png");
	...
	protected void actionPerformed(GuiButton par1GuiButton)
	{
		if (par1GuiButton.enabled)
		{
			...
			case 0:
				...
				break;
			case 1:
				if (!this.slimeling.isInLove() && this.mc.thePlayer.getGameProfile().getName().equals(this.slimeling.getOwnerName()) && this.slimeling.worldObj.isRemote)
				{
