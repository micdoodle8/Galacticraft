...
{
	private static final ResourceLocation tier2SchematicTexture = new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/gui/schematic_rocket_T2.png");
