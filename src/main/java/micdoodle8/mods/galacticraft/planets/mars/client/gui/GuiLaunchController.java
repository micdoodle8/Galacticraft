...
{
    private static final ResourceLocation launchControllerGui = new ResourceLocation(GalacticraftPlanets.ASSET_PREFIX, "textures/gui/launchController.png");
...
//		GL11.glEnable(GL11.GL_TEXTURE_2D);
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.enabled)
        {
            ...
            {
            case 0:
                GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, mc.theWorld.provider.getDimension(), new Object[] { this.launchController.getPos(), 0 }));
                break;
            case 6:
    ...
    public void onSelectionChanged(GuiElementDropdown dropdown, int selection)
    {
        if (dropdown.equals(this.dropdownTest))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimpleMars(EnumSimplePacketMars.S_UPDATE_ADVANCED_GUI, mc.theWorld.provider.getDimension(), new Object[] { 1, this.launchController.getPos(), this.launchController.launchDropdownSelection }));
        }
    }
    ...
    public void onTextChanged(GuiElementTextBox textBox, String newText)
    {
        if (FMLClientHandler.instance().getClient().thePlayer.getGameProfile().getName().equals(this.launchController.getOwnerName()))
        {
            if (textBox.equals(this.frequency))
            {
                ...
                GalacticraftCore.packetPipeline.sendToServer(new PacketSimpleMars(EnumSimplePacketMars.S_UPDATE_ADVANCED_GUI, mc.theWorld.provider.getDimension(), new Object[] { 0, this.launchController.getPos(), this.launchController.frequency }));
            }
            else if (textBox.equals(this.destinationFrequency))
            {
                this.launchController.destFrequency = textBox.getIntegerValue();
                GalacticraftCore.packetPipeline.sendToServer(new PacketSimpleMars(EnumSimplePacketMars.S_UPDATE_ADVANCED_GUI, mc.theWorld.provider.getDimension(), new Object[] { 2, this.launchController.getPos(), this.launchController.destFrequency }));
            }
        }
    }
    ...
    public void onSelectionChanged(GuiElementCheckbox checkbox, boolean newSelected)
    {
        if (checkbox.equals(this.enablePadRemovalButton))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimpleMars(EnumSimplePacketMars.S_UPDATE_ADVANCED_GUI, mc.theWorld.provider.getDimension(), new Object[] { 3, this.launchController.getPos(), this.launchController.launchPadRemovalDisabled ? 1 : 0 }));
        }
        else if (checkbox.equals(this.launchWhenCheckbox))
        {
            this.launchController.launchSchedulingEnabled = newSelected;
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimpleMars(EnumSimplePacketMars.S_UPDATE_ADVANCED_GUI, mc.theWorld.provider.getDimension(), new Object[] { 4, this.launchController.getPos(), this.launchController.launchSchedulingEnabled ? 1 : 0 }));
        }
    }
