...
{
	private static final ResourceLocation launchControllerGui = new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/gui/launchController.png");

	private TileEntityLaunchController launchController;

	private GuiButton enableControllerButton;
	private GuiCheckbox enablePadRemovalButton;
	private GuiCheckbox launchWhenCheckbox;
	private GuiDropdown dropdownTest;
	private GuiTextBox frequency;
	private GuiTextBox destinationFrequency;
	...
	public void initGui()
	{
		...
		this.enablePadRemovalButton = new GuiCheckbox(1, this, this.width / 2 - 78, var6 + 59, "Remove Pad");
		this.launchWhenCheckbox = new GuiCheckbox(2, this, this.width / 2 - 78, var6 + 77, "Launch when: ");
		this.dropdownTest = new GuiDropdown(3, this, var5 + 95, var6 + 77, EnumAutoLaunch.CARGO_IS_UNLOADED.getTitle(), EnumAutoLaunch.CARGO_IS_FULL.getTitle(), EnumAutoLaunch.ROCKET_IS_FUELED.getTitle(), EnumAutoLaunch.INSTANT.getTitle(), EnumAutoLaunch.TIME_10_SECONDS.getTitle(), EnumAutoLaunch.TIME_30_SECONDS.getTitle(), EnumAutoLaunch.TIME_1_MINUTE.getTitle(), EnumAutoLaunch.REDSTONE_SIGNAL.getTitle());
		this.frequency = new GuiTextBox(4, this, var5 + 66, var6 + 16, 48, 20, "", true, 6);
		this.destinationFrequency = new GuiTextBox(5, this, var5 + 122, var6 + 16 + 22, 48, 20, "", true, 6);
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
		...
		{
			this.fontRendererObj.drawString(this.launchController.getOwnerName(), this.xSize / 2 - this.fontRendererObj.getStringWidth(displayString) / 2, 5, this.cannotEditTimer % 30 < 15 ? CoreUtil.to32BitColor(255, 255, 100, 100) : 4210752);
	...
	public int getTextColor(GuiTextBox textBox)
	{
		if (textBox.equals(this.frequency))
		{
			return this.launchController.frequencyValid ? CoreUtil.to32BitColor(255, 20, 255, 20) : CoreUtil.to32BitColor(255, 255, 25, 25);
		}
		else if (textBox.equals(this.destinationFrequency))
		{
			return this.launchController.destFrequencyValid ? CoreUtil.to32BitColor(255, 20, 255, 20) : CoreUtil.to32BitColor(255, 255, 25, 25);
		}
