...
import micdoodle8.mods.galacticraft.planets.mars.blocks.BlockTreasureChestTier2;
...
public class TileEntityRendererTreasureChest extends TileEntitySpecialRenderer
{
	private static final ResourceLocation treasureChestTexture = new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/model/treasure.png");
	private static final ResourceLocation treasureLargeChestTexture = new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/model/treasurelarge.png");
	...
	public void renderTreasureChest(TileEntityTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		else
		{
			...
			{
				((BlockTreasureChestTier2) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
				var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
			}
		...
		if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null)
		{
			...
			if (par1GCTileEntityTreasureChest.adjacentChestXPos == null && par1GCTileEntityTreasureChest.adjacentChestZPos == null)
			{
				...
				this.bindTexture(TileEntityRendererTreasureChest.treasureChestTexture);
			}
			else
			{
				var14b = this.largeChestModel;
				this.bindTexture(TileEntityRendererTreasureChest.treasureLargeChestTexture);
			}
	...
	{
		this.renderTreasureChest((TileEntityTreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}
