...
import micdoodle8.mods.galacticraft.core.world.gen.MapGenBaseMeta;
 ...
 * 
 */
public class MapGenCavesMars extends MapGenBaseMeta
{
									...
									if (xfactorSq + zfactorSq < 1.0D)
									{
										...
										if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D)
										{
											if (blockIdArray[coords] == MarsBlocks.marsBlock)
											{
												...
												else if (metaArray[coords] == 5 && random.nextInt(MapGenCavesMars.BREAK_THROUGH_CHANCE) == 0)
												{
													blockIdArray[coords] = Blocks.air;
												}
											}
