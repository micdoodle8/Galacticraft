 ...
 * 
 */
public class BlockVines extends Block implements IShearable
{
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		...
		for (int i = 0; i < 3; i++)
		{
			this.vineIcons[i] = iconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "vine_" + i);
		}
	}
	...
	{
		return GalacticraftPlanets.proxyMars.getVineRenderID();
	}
