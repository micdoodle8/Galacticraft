...
public class Tier2RocketRecipeCategory extends BlankRecipeCategory
{
    ...
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull IRecipeWrapper recipeWrapper)
    {
        ...
        if (recipeWrapper instanceof Tier2RocketRecipeWrapper)
        {
            Tier2RocketRecipeWrapper rocketRecipeWrapper = (Tier2RocketRecipeWrapper) recipeWrapper;
