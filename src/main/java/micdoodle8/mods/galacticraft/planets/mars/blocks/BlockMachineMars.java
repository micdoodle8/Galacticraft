...
public class BlockMachineMars extends BlockTile
{
	...
	public void registerBlockIcons(IIconRegister par1IconRegister)
	{
		...
		this.iconTerraformer = par1IconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "terraformer_0");
		this.iconLaunchController = par1IconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "launchController");
		this.iconCryochamber = par1IconRegister.registerIcon(GalacticraftPlanets.TEXTURE_PREFIX + "cryoDummy");
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
	{
		...
		if (var8 instanceof IChunkLoader && !var8.getWorldObj().isRemote && ConfigManagerPlanets.launchControllerChunkLoad && entityLiving instanceof EntityPlayer)
		{
	...
	public boolean onMachineActivated(World world, int x, int y, int z, EntityPlayer par5EntityPlayer, int side, float hitX, float hitY, float hitZ)
	{
		...
		if (metadata >= BlockMachineMars.LAUNCH_CONTROLLER_METADATA)
		{
			par5EntityPlayer.openGui(GalacticraftPlanets.instance, ConfigManagerPlanets.idGuiMachine, world, x, y, z);
			return true;
		}
		else if (metadata >= BlockMachineMars.CRYOGENIC_CHAMBER_METADATA)
		{
	...
	{
		return GalacticraftPlanets.proxyMars.getMachineRenderID();
	}
