package micdoodle8.mods.galacticraft.planets.mars.proxy;
...
import micdoodle8.mods.galacticraft.planets.mars.client.render.block.BlockRendererSlimelingEgg;
import micdoodle8.mods.galacticraft.planets.mars.client.render.block.BlockRendererTintedGlassPane;
import micdoodle8.mods.galacticraft.planets.mars.client.render.block.BlockRendererTreasureChest;
import micdoodle8.mods.galacticraft.planets.mars.client.render.block.BlockRendererVines;
...
import micdoodle8.mods.galacticraft.planets.mars.client.render.tile.TileEntityRendererCryoChamber;
import micdoodle8.mods.galacticraft.planets.mars.client.render.tile.TileEntityRendererTreasureChest;
 ...
 * 
 */
public class ClientProxyMars2 extends CommonProxyMars
{
	...
	public void init(FMLInitializationEvent event)
	{
		...
		ClientProxyMars2.vineRenderID = RenderingRegistry.getNextAvailableRenderId();
		RenderingRegistry.registerBlockHandler(new BlockRendererVines(ClientProxyMars2.vineRenderID));
		ClientProxyMars2.eggRenderID = RenderingRegistry.getNextAvailableRenderId();
		RenderingRegistry.registerBlockHandler(new BlockRendererSlimelingEgg(ClientProxyMars2.eggRenderID));
		ClientProxyMars2.treasureRenderID = RenderingRegistry.getNextAvailableRenderId();
		RenderingRegistry.registerBlockHandler(new BlockRendererTreasureChest(ClientProxyMars2.treasureRenderID));
		ClientProxyMars2.machineRenderID = RenderingRegistry.getNextAvailableRenderId();
		RenderingRegistry.registerBlockHandler(new BlockRendererMachine(ClientProxyMars2.machineRenderID));
		ClientProxyMars2.tintedGlassRenderID = RenderingRegistry.getNextAvailableRenderId();
		RenderingRegistry.registerBlockHandler(new BlockRendererTintedGlassPane(ClientProxyMars2.tintedGlassRenderID));
	}

	@Override
	public void postInit(FMLPostInitializationEvent event)
	{
		IModelCustom chamberModel = AdvancedModelLoader.loadModel(new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "models/chamber.obj"));
		IModelCustom cargoRocketModel = AdvancedModelLoader.loadModel(new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "models/cargoRocket.obj"));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityTier2Rocket.class, new RenderTier1Rocket(new ModelTier2Rocket(), GalacticraftPlanets.ASSET_DOMAIN, "rocketT2"));
		...
		MinecraftForgeClient.registerItemRenderer(MarsItems.key, new ItemRendererKey(new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/model/treasure.png")));
	...
	{
		return ClientProxyMars2.vineRenderID;
	}

	@Override
	public int getEggRenderID()
	{
		return ClientProxyMars2.eggRenderID;
	}

	@Override
	public int getTreasureRenderID()
	{
		return ClientProxyMars2.treasureRenderID;
	}

	@Override
	public int getMachineRenderID()
	{
		return ClientProxyMars2.machineRenderID;
	}

	@Override
	public int getTintedGlassPaneRenderID()
	{
		return ClientProxyMars2.tintedGlassRenderID;
	}
	...
	{
		return ClientProxyMars2.handleBacterialMovement(player) || ClientProxyMars2.handleLavaMovement(player) || ClientProxyMars2.handleWaterMovement(player);
	}

	@Override
	public void openSlimelingGui(EntitySlimeling slimeling, int gui)
	{
		switch (gui)
		{
		case 0:
...
//					} TODO Fix rocket sound updater
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		if (ID == ConfigManagerPlanets.idGuiMachine)
		{
