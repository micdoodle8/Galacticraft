...
{
	private static final ResourceLocation landerTexture = new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "textures/model/landingBalloon.png");
	...
	{
		this.shadowSize = 2F;
		this.landerModel = AdvancedModelLoader.loadModel(new ResourceLocation(GalacticraftPlanets.ASSET_DOMAIN, "models/landingBalloon.obj"));
	}
