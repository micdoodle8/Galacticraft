...
public class ItemThrowableMeteor extends Item
{
	...
	public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5)
	{
		if (itemstack.getItemDamage() == 1 && !world.isRemote)
		{
			...
			else
			{
				...
				itemstack.getTagCompound().setFloat("MeteorBurnTimeF", ItemThrowableMeteor.METEOR_BURN_TIME);
			}
		}
	}
	...
	{
		return "item." + ItemThrowableMeteor.names[itemStack.getItemDamage()];
	}
