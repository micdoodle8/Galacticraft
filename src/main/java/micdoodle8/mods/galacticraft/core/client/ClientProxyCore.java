...
public class ClientProxyCore extends CommonProxyCore
{
	...
	{
		RenderingRegistry.registerEntityRenderingHandler(EntityTier1Rocket.class, new GCCoreRenderSpaceship(new GCCoreModelSpaceship(), GalacticraftCore.ASSET_DOMAIN, "rocketT1"));
		RenderingRegistry.registerEntityRenderingHandler(EntitySpider.class, new GCCoreRenderSpider());
		RenderingRegistry.registerEntityRenderingHandler(EntityZombie.class, new GCCoreRenderZombie());
		RenderingRegistry.registerEntityRenderingHandler(EntityCreeper.class, new GCCoreRenderCreeper());
		RenderingRegistry.registerEntityRenderingHandler(EntitySkeleton.class, new GCCoreRenderSkeleton());
		RenderingRegistry.registerEntityRenderingHandler(EntitySkeletonBoss.class, new GCCoreRenderSkeletonBoss());
		RenderingRegistry.registerEntityRenderingHandler(EntityMeteor.class, new GCCoreRenderMeteor());
		RenderingRegistry.registerEntityRenderingHandler(EntityBuggy.class, new GCCoreRenderBuggy());
		RenderingRegistry.registerEntityRenderingHandler(EntityMeteorChunk.class, new GCCoreRenderMeteorChunk());
		RenderingRegistry.registerEntityRenderingHandler(EntityFlag.class, new GCCoreRenderFlag());
		RenderingRegistry.registerEntityRenderingHandler(EntityParachest.class, new GCCoreRenderParaChest());
		RenderingRegistry.registerEntityRenderingHandler(EntityPlayer.class, new GCCoreRenderPlayer());
		RenderingRegistry.registerEntityRenderingHandler(EntityAlienVillager.class, new GCCoreRenderAlienVillager());
		RenderingRegistry.registerEntityRenderingHandler(EntityBubble.class, new GCCoreRenderOxygenBubble(0.25F, 0.25F, 1.0F));
		RenderingRegistry.registerEntityRenderingHandler(EntityLander.class, new GCCoreRenderLander());
		RenderingRegistry.registerEntityRenderingHandler(EntityArrow.class, new GCCoreRenderArrow());
	}
	...
	public static void registerItemRenderers()
	{
		...
		MinecraftForgeClient.registerItemRenderer(GCCoreItems.rocketTier1, new GCCoreItemRendererSpaceship(new EntityTier1Rocket(FMLClientHandler.instance().getClient().theWorld), new GCCoreModelSpaceship(), new ResourceLocation(GalacticraftCore.ASSET_DOMAIN, "textures/model/rocketT1.png")));
