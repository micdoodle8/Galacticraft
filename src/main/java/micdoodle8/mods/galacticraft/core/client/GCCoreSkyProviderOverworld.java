...
public class GCCoreSkyProviderOverworld extends IRenderHandler
{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		var12 = 30.0F;
		this.minecraft.renderEngine.bindTexture(GCCoreSkyProviderOverworld.sunTexture);
		...
		var12 = 40.0F;
		this.minecraft.renderEngine.bindTexture(GCCoreSkyProviderOverworld.moonTexture);
