...
public class RenderArrowGC extends Render
{
	private static final ResourceLocation arrowTexture = new ResourceLocation("textures/entity/arrow.png");

	public void renderArrow(EntityArrowGC par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
	{
	...
	protected ResourceLocation func_110779_a(EntityArrowGC par1EntityArrow)
	{
		return RenderArrowGC.arrowTexture;
	}

	@Override
	protected ResourceLocation getEntityTexture(Entity par1Entity)
	{
		return this.func_110779_a((EntityArrowGC) par1Entity);
	}

	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
	{
		this.renderArrow((EntityArrowGC) par1Entity, par2, par4, par6, par8, par9);
	}
}
