 ...
 * 
 */
public class GuiSchematicBuggy extends GuiAdvancedContainer implements ISchematicResultPage
{
	...
	{
		this.fontRendererObj.drawString(StatCollector.translateToLocal("schematic.moonbuggy.name"), 7, -20 + 27, 4210752);
