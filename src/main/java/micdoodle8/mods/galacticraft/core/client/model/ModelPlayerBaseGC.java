...
//            this.modelPlayer.bipedRightArm.rotateAngleX -= (float)Math.cos(par1 * 0.6662F + (float)Math.PI) * rightMod * par2 * 0.5F;
//            this.modelPlayer.bipedLeftArm.rotateAngleX -= (float)Math.cos(par1 * 0.6662F) * 2.0F * par2 * 0.5F;
...
//            this.modelPlayer.bipedLeftLeg.rotateAngleX -= (float)Math.cos(par1 * 0.6662F + (float)Math.PI) * 1.4F * par2;
//            this.modelPlayer.bipedLeftLeg.rotateAngleX += (float)Math.cos(par1 * 0.1162F * 2 + (float)Math.PI) * 1.4F * par2;
//            this.modelPlayer.bipedRightLeg.rotateAngleX -= (float)Math.cos(par1 * 0.6662F) * 1.4F * par2;
//            this.modelPlayer.bipedRightLeg.rotateAngleX += (float)Math.cos(par1 * 0.1162F * 2) * 1.4F * par2;
////    		this.modelPlayer.bipedRightArm.rotateAngleX = -angularSwingArm * 4.0F * par2 * 0.5F;
////    		this.modelPlayer.bipedLeftArm.rotateAngleX = angularSwingArm * 4.0F * par2 * 0.5F;
////    		this.modelPlayer.bipedLeftLeg.rotateAngleX = (float)Math.cos(par1 * 0.1162F * 2 + (float)Math.PI) * 1.4F * par2;
////    		this.modelPlayer.bipedRightLeg.rotateAngleX = (float)Math.cos(par1 * 0.1162F * 2) * 1.4F * par2;
...
//                {
//                    this.modelPlayer.bipedRightArm.rotateAngleZ -= (float) (Math.PI / 8) + (float)Math.sin(par3 * 0.9F) * 0.2F;
//                    this.modelPlayer.bipedRightArm.rotateAngleX = (float) Math.PI;
//                    break;
//                }
//            }
