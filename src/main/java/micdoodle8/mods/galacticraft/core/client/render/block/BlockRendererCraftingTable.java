 ...
 * 
 */
public class BlockRendererCraftingTable implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public BlockRendererCraftingTable(int var1)
	{
		this.renderID = var1;
	}
	...
	private final TileEntityAdvancedCraftingTable table = new TileEntityAdvancedCraftingTable();
