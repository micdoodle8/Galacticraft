...
import micdoodle8.mods.galacticraft.core.client.gui.element.GuiTurnPageButton;
...
public class GuiManual extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiTurnPageButton(1, xPos + this.bookImageWidth - 50, 195, true));
        this.buttonList.add(new GuiTurnPageButton(2, xPos - this.bookImageWidth + 24, 195, false));
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.mc.getTextureManager().bindTexture(GuiManual.bookRight);
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        this.mc.getTextureManager().bindTexture(GuiManual.bookLeft);
