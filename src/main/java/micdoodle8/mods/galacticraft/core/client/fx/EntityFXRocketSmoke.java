...
public class EntityFXRocketSmoke extends EntityFX
{
	float smokeParticleScale;

	public EntityFXRocketSmoke(World par1World, Vector3 position, Vector3 motion, float size, boolean launched)
	{
