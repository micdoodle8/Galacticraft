 ...
 * 
 */
public class GuiAirDistributor extends GuiAdvancedContainer
{
    ...
    public GuiAirDistributor(InventoryPlayer par1InventoryPlayer, TileEntityOxygenDistributor par2TileEntityAirDistributor)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        this.mc.getTextureManager().bindTexture(GuiAirDistributor.distributorTexture);
