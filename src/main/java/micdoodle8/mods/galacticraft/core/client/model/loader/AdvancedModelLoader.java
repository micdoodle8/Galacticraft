...
import micdoodle8.mods.galacticraft.core.client.model.loader.obj.ObjModelLoader;
 ...
 * Instances can be created by calling {@link #loadModel(ResourceLocation)} with a class-loadable-path
 *
 * @author cpw
 *
 */
...
public class AdvancedModelLoader {
     ...
     * @param resourceLoc The resource name
     * @return A model
     ...
     */
    public static IModelCustom loadModel(ResourceLocation resourceLoc) throws IllegalArgumentException, ModelFormatException
    {
        String resourceName = String.format("/%s/%s/%s", "assets", resourceLoc.getResourceDomain(), resourceLoc.getResourcePath());
