...
public class ModelSolarPanel extends ModelBase
{
    ...
    RendererModel sideVertical0;
    RendererModel sideVertical2;
    RendererModel sideVertical1;
    RendererModel sideHorizontal1;
    RendererModel sideHorizontal3;
    RendererModel sideHorizontal2;
    RendererModel pole;
    ...
    public ModelSolarPanel(float var1)
    {
        ...
        this.sideHorizontal0 = new RendererModel(this, 0, 48);
        ...
        this.sideVertical0 = new RendererModel(this, 94, 48);
        ...
        this.sideVertical2 = new RendererModel(this, 94, 48);
        ...
        this.sideVertical1 = new RendererModel(this, 94, 48);
        ...
        this.sideHorizontal1 = new RendererModel(this, 0, 48);
        ...
        this.sideHorizontal3 = new RendererModel(this, 0, 48);
        ...
        this.sideHorizontal2 = new RendererModel(this, 0, 48);
        ...
        this.pole = new RendererModel(this, 94, 50);
