...
import micdoodle8.mods.galacticraft.core.client.model.ModelSkeletonBoss;
...
public class RenderSkeletonBoss extends RenderLiving
{
	...
	private final ModelSkeletonBoss model = new ModelSkeletonBoss();

	public RenderSkeletonBoss()
	{
		super(new ModelSkeletonBoss(), 1.0F);
	}

	protected ResourceLocation func_110779_a(EntitySkeletonBoss par1EntityArrow)
	{
		return RenderSkeletonBoss.skeletonBossTexture;
	}
	...
	protected int shouldRenderPass(EntityLivingBase par1EntityLiving, int par2, float par3)
	{
		...
		if (helmetSlot != null && helmetSlot.getItem() instanceof ItemSensorGlasses && minecraft.currentScreen == null)
		{
			if (par2 == 1)
			{
				...
				this.bindTexture(RenderSkeletonBoss.powerTexture);
