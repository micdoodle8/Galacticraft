...
public class GCCoreSmallFontRenderer implements IResourceManagerReloadListener
{
	...
	public GCCoreSmallFontRenderer(GameSettings par1GameSettings, ResourceLocation par2ResourceLocation, TextureManager par3TextureManager, boolean par4)
	{
	...
	{
		if (GCCoreSmallFontRenderer.field_111274_c[par1] == null)
		{
			GCCoreSmallFontRenderer.field_111274_c[par1] = new ResourceLocation(String.format("textures/font/unicode_page_%02x.png", new Object[] { Integer.valueOf(par1) }));
		}

		return GCCoreSmallFontRenderer.field_111274_c[par1];
	}
	...
	String wrapFormattedStringToWidth(String par1Str, int par2)
	{
		...
		else
		{
			...
			String s2 = GCCoreSmallFontRenderer.getFormatFromString(s1) + par1Str.substring(j + (flag ? 1 : 0));
		...
		for (boolean flag = false; l < j; ++l)
		{
			...
			case 167:
				if (l < j - 1)
				{
					...
					if (c1 != 108 && c1 != 76)
					{
						if (c1 == 114 || c1 == 82 || GCCoreSmallFontRenderer.isFormatColor(c1))
						{
							flag = false;
						}
					}
