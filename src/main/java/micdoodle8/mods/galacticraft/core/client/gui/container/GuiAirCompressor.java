 ...
 * 
 */
public class GuiAirCompressor extends GuiAdvancedContainer
{
    ...
    public GuiAirCompressor(InventoryPlayer par1InventoryPlayer, TileEntityOxygenCompressor par2TileEntityAirDistributor)
    {
    ...
    public void initGui()
    {
        ...
        this.infoRegions.add(new InfoRegion((this.width - this.xSize) / 2 + 132, (this.height - this.ySize) / 2 + 70, 18, 18, compressorSlotDesc, this.width, this.height));
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        this.mc.getTextureManager().bindTexture(GuiAirCompressor.compressorTexture);
