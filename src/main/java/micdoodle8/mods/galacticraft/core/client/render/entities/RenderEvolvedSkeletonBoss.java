...
//            FMLClientHandler.instance().getClient().getItemRenderer().renderItem(par1EntityLiving, new ItemStack(Items.bow), 0);
//            GL11.glPopMatrix();
//
//            GL11.glPushMatrix();
...
//            GL11.glRotatef(-20, 0.0F, 0.0F, 1.0F);
//            GL11.glScalef(0.7F, 0.7F, 0.7F);
//            FMLClientHandler.instance().getClient().getItemRenderer().renderItem(par1EntityLiving, new ItemStack(Items.bow), );
//            GL11.glPopMatrix();
//        }
//    }
//
