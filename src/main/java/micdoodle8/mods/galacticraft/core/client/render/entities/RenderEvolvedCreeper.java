...
public class RenderEvolvedCreeper extends RenderLiving
{
	...
	protected ResourceLocation func_110779_a(EntityEvolvedCreeper par1EntityArrow)
	{
	...
	{
		return this.func_110779_a((EntityEvolvedCreeper) par1Entity);
	}

	protected void updateCreeperScale(EntityEvolvedCreeper par1GCEntityCreeper, float par2)
	{
	...
	protected int updateCreeperColorMultiplier(EntityEvolvedCreeper par1GCEntityCreeper, float par2, float par3)
	{
	...
	protected int renderCreeperPassModel(EntityEvolvedCreeper par1GCEntityCreeper, int par2, float par3)
	{
	...
	protected int func_77061_b(EntityEvolvedCreeper par1GCEntityCreeper, int par2, float par3)
	{
		return -1;
	}
	...
	{
		this.updateCreeperScale((EntityEvolvedCreeper) par1EntityLiving, par2);
	}

	@Override
	protected int getColorMultiplier(EntityLivingBase par1EntityLiving, float par2, float par3)
	{
		return this.updateCreeperColorMultiplier((EntityEvolvedCreeper) par1EntityLiving, par2, par3);
	}

	@Override
	protected int shouldRenderPass(EntityLivingBase par1EntityLiving, int par2, float par3)
	{
		return this.renderCreeperPassModel((EntityEvolvedCreeper) par1EntityLiving, par2, par3);
	}

	@Override
	protected int inheritRenderPass(EntityLivingBase par1EntityLiving, int par2, float par3)
	{
		return this.func_77061_b((EntityEvolvedCreeper) par1EntityLiving, par2, par3);
	}
}
