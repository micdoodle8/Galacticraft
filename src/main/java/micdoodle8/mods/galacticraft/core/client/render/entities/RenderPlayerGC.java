...
public class RenderPlayerGC extends RenderPlayer
{
	...
	// @Override TODO Fix capes
	// protected void renderEquippedItems(AbstractClientPlayer
	// par1AbstractClientPlayer, float par2)
	// {
	// RenderPlayerEvent.Specials.Pre event = new
	// RenderPlayerEvent.Specials.Pre(par1AbstractClientPlayer, this, par2);
	...
	// ItemStack itemstack =
	// par1AbstractClientPlayer.inventory.armorItemInSlot(3);
	//
	...
	// MinecraftForgeClient.getItemRenderer(itemstack, EQUIPPED);
	...
	// }
	//
	// this.renderManager.itemRenderer.renderItem(par1AbstractClientPlayer,
	// itemstack, 0);
	// }
	...
	// }
	//
	// TileEntitySkullRenderer.field_147536_b.func_147530_a(-0.5F, 0.0F, -0.5F,
	// 1, 180.0F, itemstack.getItemDamage(), s);
	// }
	//
	// GL11.glPopMatrix();
	// }
	//
	// boolean flag =
	// par1AbstractClientPlayer.getTextureCape().isTextureUploaded();
	...
	// (par1AbstractClientPlayer.field_71094_bP -
	// par1AbstractClientPlayer.field_71091_bM) * par2 -
	// (par1AbstractClientPlayer.prevPosX + (par1AbstractClientPlayer.posX -
	// par1AbstractClientPlayer.prevPosX) * par2);
	// double d1 = par1AbstractClientPlayer.field_71096_bN +
	// (par1AbstractClientPlayer.field_71095_bQ -
	// par1AbstractClientPlayer.field_71096_bN) * par2 -
	// (par1AbstractClientPlayer.prevPosY + (par1AbstractClientPlayer.posY -
	// par1AbstractClientPlayer.prevPosY) * par2);
	// double d2 = par1AbstractClientPlayer.field_71097_bO +
	// (par1AbstractClientPlayer.field_71085_bR -
	// par1AbstractClientPlayer.field_71097_bO) * par2 -
	// (par1AbstractClientPlayer.prevPosZ + (par1AbstractClientPlayer.posZ -
	// par1AbstractClientPlayer.prevPosZ) * par2);
	// f6 = par1AbstractClientPlayer.prevRenderYawOffset +
	// (par1AbstractClientPlayer.renderYawOffset -
	// par1AbstractClientPlayer.prevRenderYawOffset) * par2;
	...
	// (par1AbstractClientPlayer.cameraYaw -
	// par1AbstractClientPlayer.prevCameraYaw) * par2;
	// f7 += MathHelper.sin((par1AbstractClientPlayer.prevDistanceWalkedModified
	// + (par1AbstractClientPlayer.distanceWalkedModified -
	// par1AbstractClientPlayer.prevDistanceWalkedModified) * par2) * 6.0F) *
	// 32.0F * f10;
	//
	...
	// par1AbstractClientPlayer.inventory.getCurrentItem();
	//
	...
	//
	// IItemRenderer customRenderer =
	// MinecraftForgeClient.getItemRenderer(itemstack1, EQUIPPED);
	// boolean is3D = customRenderer != null &&
	// customRenderer.shouldUseRenderHelper(EQUIPPED, itemstack1, BLOCK_3D);
	// boolean isBlock = Item.getIdFromItem(itemstack1.getItem()) <
	// Block.blocksList.length && itemstack1.getItemSpriteNumber() == 0;
	//
	// if (is3D || isBlock &&
	...
	// }
	// else if (itemstack1.itemID == Item.bow.itemID || itemstack1.itemID ==
	// GCCoreItems.bowGravity.itemID)
	// {
	// f11 = 0.625F;
	...
	// }
	//
	// if (par1AbstractClientPlayer.getItemInUseCount() > 0 && enumaction ==
	// EnumAction.block)
	// {
	...
	// {
	// for (j = 0; j <
	// itemstack1.getItem().getRenderPasses(itemstack1.getItemDamage()); ++j)
	// {
	...
	// RenderPlayerEvent.Specials.Post(par1AbstractClientPlayer, this, par2));
	// }
