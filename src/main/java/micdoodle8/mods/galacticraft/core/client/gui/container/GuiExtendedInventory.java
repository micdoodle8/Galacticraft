...
//            }
    ...
    public static void drawPlayerOnGui(Minecraft minecraft, int x, int y, int scale)
    {
        ...
        float f5 = minecraft.player.prevRotationYawHead;
        float f6 = minecraft.player.rotationYawHead;
        ...
        minecraft.player.rotationPitch = GuiExtendedInventory.rotation;
        ...
        minecraft.player.prevRotationYawHead = f5;
        minecraft.player.rotationYawHead = f6;
