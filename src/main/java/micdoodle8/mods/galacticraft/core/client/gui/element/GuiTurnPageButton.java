...
public class GuiTurnPageButton extends GuiButton
{
	...
	public GuiTurnPageButton(int par1, int par2, int par3, boolean par4)
	{
	...
	public void drawButton(Minecraft par1Minecraft, int par2, int par3)
	{
		if (this.visible)
		{
			...
			par1Minecraft.getTextureManager().bindTexture(GuiTurnPageButton.background);
			int var5 = 0;
			int var6 = 192;
