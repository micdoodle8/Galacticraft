...
public class GCCoreGuiCargoLoader extends GCCoreGuiContainer
{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
		...
		this.fontRendererObj.drawString(ElectricityDisplay.getDisplay(GCCoreTileEntityCargoLoader.WATTS_PER_TICK * 20, ElectricUnit.WATT), 28 + offsetX, 56 + 23 - 46 + offsetY, 4210752);
