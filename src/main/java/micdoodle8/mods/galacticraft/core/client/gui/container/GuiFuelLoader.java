...
public class GuiFuelLoader extends GuiContainerGC
{
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
        case 0:
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, this.fuelLoader.getWorld().provider.getDimensionId(), new Object[] { this.fuelLoader.getPos(), 0 }));
            break;
        }
    }
