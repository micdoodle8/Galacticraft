...
public class RenderEvolvedSpider extends RenderLiving
{
	...
	protected ResourceLocation func_110779_a(EntityEvolvedSpider par1EntityArrow)
	{
	...
	{
		return this.func_110779_a((EntityEvolvedSpider) par1Entity);
	}

	protected float setSpiderDeathMaxRotation(EntityEvolvedSpider par1EntitySpider)
	{
		return 180.0F;
	}
	...
	{
		return this.setSpiderDeathMaxRotation((EntityEvolvedSpider) par1EntityLiving);
	}
}
