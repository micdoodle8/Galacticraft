...
public class ModelEvolvedSpider extends ModelBase
{
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        final float var10 = -((float)Math.cos(f * 0.6662F * 2.0F + 0.0F) * 0.4F) * f1;
        final float var11 = -((float)Math.cos(f * 0.6662F * 2.0F + (float) Math.PI) * 0.4F) * f1;
        final float var12 = -((float)Math.cos(f * 0.6662F * 2.0F + (float) Math.PI / 2F) * 0.4F) * f1;
        final float var13 = -((float)Math.cos(f * 0.6662F * 2.0F + (float) Math.PI * 3F / 2F) * 0.4F) * f1;
        final float var14 = Math.abs((float)Math.sin(f * 0.6662F + 0.0F) * 0.4F) * f1;
        final float var15 = Math.abs((float)Math.sin(f * 0.6662F + (float) Math.PI) * 0.4F) * f1;
        final float var16 = Math.abs((float)Math.sin(f * 0.6662F + (float) Math.PI / 2F) * 0.4F) * f1;
        final float var17 = Math.abs((float)Math.sin(f * 0.6662F + (float) Math.PI * 3F / 2F) * 0.4F) * f1;
