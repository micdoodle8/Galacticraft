...
public class ModelEvolvedSpider extends EntityModel<EntityEvolvedSpider>
{
    ...
    public void setRotationAngles(EntityEvolvedSpider entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        final float var10 = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F + 0.0F) * 0.4F) * limbSwingAmount;
        final float var11 = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F + (float) Math.PI) * 0.4F) * limbSwingAmount;
        final float var12 = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F + Constants.halfPI) * 0.4F) * limbSwingAmount;
        final float var13 = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F + 3F * Constants.halfPI) * 0.4F) * limbSwingAmount;
        final float var14 = Math.abs(MathHelper.sin(limbSwing * 0.6662F + 0.0F) * 0.4F) * limbSwingAmount;
        final float var15 = Math.abs(MathHelper.sin(limbSwing * 0.6662F + (float) Math.PI) * 0.4F) * limbSwingAmount;
        final float var16 = Math.abs(MathHelper.sin(limbSwing * 0.6662F + Constants.halfPI) * 0.4F) * limbSwingAmount;
        final float var17 = Math.abs(MathHelper.sin(limbSwing * 0.6662F + 3F * Constants.halfPI) * 0.4F) * limbSwingAmount;
