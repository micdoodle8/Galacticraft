...
public class GCCoreGuiAirSealer extends GCCoreGuiContainer
{
	...
	private String getStatus()
	{
		...
		if (blockAbove != Blocks.air && blockAbove != GCCoreBlocks.breatheableAir && !OxygenPressureProtocol.canBlockPassAir(this.sealer.getWorldObj(), Block.getIdFromBlock(blockAbove), new BlockVec3(this.sealer.xCoord, this.sealer.yCoord + 1, this.sealer.zCoord), 0))
		{
