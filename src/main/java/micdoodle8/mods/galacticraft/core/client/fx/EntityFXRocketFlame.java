...
public class EntityFXRocketFlame extends EntityFX
{
	float smokeParticleScale;
	boolean spawnSmokeShort;

	public EntityFXRocketFlame(World par1World, Vector3 position, Vector3 motion, float size, boolean launched)
	{
