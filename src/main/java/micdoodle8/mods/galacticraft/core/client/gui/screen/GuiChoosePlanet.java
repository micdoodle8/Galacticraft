...
import micdoodle8.mods.galacticraft.core.client.gui.element.GuiElementTexturedButton;
...
public class GuiChoosePlanet extends GuiScreen
{
	...
	private GuiChoosePlanetSlot planetSlots;
	...
	public static FontRenderer getFontRenderer(GuiChoosePlanet gui)
	{
		return gui.fontRendererObj;
	}
	...
	public void initGui()
	{
		...
		GCCoreEventChoosePlanetGui.Init event = new GCCoreEventChoosePlanetGui.Init(new ArrayList<GuiButton>());
	...
	private void drawPanorama2(float par1)
	{
		...
		for (int var6 = 0; var6 < var5 * var5; ++var6)
		{
			...
			for (int var10 = 0; var10 < 9; ++var10)
			{
				...
				this.mc.getTextureManager().bindTexture(GuiChoosePlanet.backgroundTexture);
	...
	protected void drawItemStackTooltip(HashMap<Integer, ToolTipEntry> itemList, int par2, int par3)
	{
		...
		if (!itemList.isEmpty())
		{
			...
			this.zLevel = 300.0F;
			GuiChoosePlanet.drawItems.zLevel = 300.0F;
			...
			this.zLevel = 0.0F;
			GuiChoosePlanet.drawItems.zLevel = 0.0F;
		}
	}
	...
	protected void actionPerformed(GuiButton par1GuiButton)
	{
		...
		{
		case 0:
			FMLClientHandler.instance().getClient().displayGuiScreen(new GuiGalaxyMap(this.playerToSend, this.destinations));
			break;
		case 1:
	...
	static EntityPlayer getPlayerToSend(GuiChoosePlanet par0GuiLanguage)
	{
		return par0GuiLanguage.playerToSend;
	}

	static String[] getDestinations(GuiChoosePlanet par0GuiLanguage)
	{
	...
	static int setSelectedDimension(GuiChoosePlanet par0GuiLanguage, int par1)
	{
