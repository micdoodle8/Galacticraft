 ...
 * 
 */
public class GuiSchematicRocketT1 extends GuiAdvancedContainer implements ISchematicResultPage
{
	...
	{
		this.fontRendererObj.drawString(StatCollector.translateToLocal("schematic.rocketT1.name"), 7, -20 + 27, 4210752);
		this.fontRendererObj.drawString(StatCollector.translateToLocal("container.inventory"), 8, 202 - 104 + 2 + 27, 4210752);
	}
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		this.mc.renderEngine.bindTexture(GuiSchematicRocketT1.rocketBenchTexture);
