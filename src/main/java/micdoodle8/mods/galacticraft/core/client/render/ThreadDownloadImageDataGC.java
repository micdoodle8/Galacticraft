...
//                GCLog.info("Downloading http texture from %s to %s", ThreadDownloadImageDataGC.this.imageUrl, ThreadDownloadImageDataGC.this.field_152434_e);
//
//                try
//                {
...
//                    {
//                        NativeImage nativeimage = NativeImage.read(new FileInputStream(this.cacheFile));
//                        if (this.imageBuffer != null) {
