...
public class OverlaySpaceship extends Overlay
{
	...
	public static void renderSpaceshipOverlay(ResourceLocation guiTexture)
	{
		...
		final ScaledResolution scaledresolution = new ScaledResolution(OverlaySpaceship.minecraft.gameSettings, OverlaySpaceship.minecraft.displayWidth, OverlaySpaceship.minecraft.displayHeight);
		scaledresolution.getScaledWidth();
		final int height = scaledresolution.getScaledHeight();
		OverlaySpaceship.minecraft.entityRenderer.setupOverlayRendering();
		...
		GL11.glPushMatrix();
		final int i = OverlaySpaceship.minecraft.thePlayer.ridingEntity.getBrightnessForRender(1);
		final int j = i % 65536;
		final int k = i / 65536;
		...
		try
		{
			spaceship.renderSpaceship((EntitySpaceshipBase) OverlaySpaceship.minecraft.thePlayer.ridingEntity.getClass().getConstructor(World.class).newInstance(OverlaySpaceship.minecraft.thePlayer.worldObj), 0, 0, 0, 0, 0);
		}
		catch (Exception e)
		{
			e.printStackTrace();
