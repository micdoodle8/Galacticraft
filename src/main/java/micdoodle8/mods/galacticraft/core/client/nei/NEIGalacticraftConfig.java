...
//        int siliconCount = OreDictionary.getOres(ConfigManagerCore.otherModsSilicon.get()).size();
...
//        {
//        	silicons[j] = OreDictionary.getOres(ConfigManagerCore.otherModsSilicon.get()).get(j);
//        }
...
//        this.registerCircuitFabricatorRecipe(input1, new PositionedStack(new ItemStack(GCItems.basicItem, ConfigManagerCore.quickMode.get() ? 5 : 3, 13), 147, 91));
//
//        HashMap<Integer, PositionedStack> input2 = new HashMap<Integer, PositionedStack>(input1);
...
//        this.registerCircuitFabricatorRecipe(input2, new PositionedStack(new ItemStack(GCItems.basicItem, ConfigManagerCore.quickMode.get() ? 2 : 1, 14), 147, 91));
//    }
//
