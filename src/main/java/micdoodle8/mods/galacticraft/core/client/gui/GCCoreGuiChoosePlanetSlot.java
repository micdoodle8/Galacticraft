...
public class GCCoreGuiChoosePlanetSlot extends GuiSlot
{
	...
	{
		if (var1 < GCCoreGuiChoosePlanet.getDestinations(this.choosePlanetGui).length)
		{
			GCCoreGuiChoosePlanet.setSelectedDimension(this.choosePlanetGui, var1);
	...
	@Override
    protected void drawSlot(int par1, int par2, int par3, int par4, Tessellator par5Tessellator, int var6, int var7)
	{
		GL11.glPushMatrix();
