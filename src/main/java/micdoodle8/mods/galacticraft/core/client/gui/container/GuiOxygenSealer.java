...
public class GuiOxygenSealer extends GuiContainerGC
{
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
        case 0:
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, mc.theWorld.provider.getDimensionId(), new Object[] { this.sealer.getPos().getX(), this.sealer.getPos().getY(), this.sealer.getPos().getZ(), 0 }));
            break;
        }
    }
    ...
    public void initGui()
    {
        ...
        oxygenDesc.add(EnumColor.YELLOW + GCCoreUtil.translate("gui.oxygen_storage.desc.1") + ": " + ((int) Math.floor(this.sealer.storedOxygen) + " / " + (int) Math.floor(this.sealer.maxOxygen)));
    ...
    {
        this.fontRendererObj.drawString(this.sealer.getName(), 8, 10, 4210752);
