...
//        worldRenderer.begin(7, DefaultVertexFormats.POSITION);
//
//        for (int var3 = 0; var3 < (ConfigManagerCore.INSTANCE.moreStars.get() ? 20000 : 6000); ++var3)
//        {
...
//                var6 *= var12;
//                var8 *= var12;
//                final double var14 = var4 * (ConfigManagerCore.INSTANCE.moreStars ? var1.nextDouble() * 100D + 150D : 100.0D);
//                final double var16 = var6 * (ConfigManagerCore.INSTANCE.moreStars ? var1.nextDouble() * 100D + 150D : 100.0D);
//                final double var18 = var8 * (ConfigManagerCore.INSTANCE.moreStars ? var1.nextDouble() * 100D + 150D : 100.0D);
