...
public class GuiNewSpaceRace extends GuiScreen implements ICheckBoxCallback
{
	...
	private GCCoreGuiCheckbox checkboxCompete;
	private GCCoreGuiCheckbox checkboxUploadScore;
	private GCCoreGuiCheckbox checkboxShowFace;
	private GCCoreGuiCheckbox checkboxPaintbrush;
	private GCCoreGuiCheckbox checkboxShowGrid;
	private GCCoreGuiCheckbox checkboxEraser;
	private GCCoreGuiCheckbox checkboxSelector;
	private GCCoreGuiCheckbox checkboxColorSelector;
	private boolean initialized;
	private GCCoreGuiSlider sliderColorR;
	private GCCoreGuiSlider sliderColorG;
	private GCCoreGuiSlider sliderColorB;
	private GCCoreGuiSlider sliderBrushSize;
	private GCCoreGuiSlider sliderEraserSize;
	...
	private GCCoreModelFlag dummyModel = new GCCoreModelFlag();
	...
	public void initGui()
	{
		...
		if (this.initialized)
		{
			...
			this.buttonList.add(new GCCoreGuiGradientButton(0, this.width / 2 - this.width / 3 + 15, this.height / 2 - this.height / 4 - 15, 50, 15, this.currentState == EnumSpaceRaceGui.MAIN ? "Close" : "Back"));
			
			switch (this.currentState)
			{
			case MAIN:
				this.checkboxCompete = new GCCoreGuiCheckbox(1, this, this.width / 2 - 125, var6 - 10, "Compete against other players on this world?", GCCoreUtil.to32BitColor(255, 240, 240, 240));
				this.checkboxUploadScore = new GCCoreGuiCheckbox(2, this, this.width / 2 - 125, var6 + 5, "Upload score to Galacticraft website?", GCCoreUtil.to32BitColor(255, 240, 240, 240));
				this.buttonList.add(new GCCoreGuiGradientButton(3, this.width / 2 + this.width / 3 - 125, this.height / 2 + this.height / 4 - 25, 50, 15, "Rules"));
				this.buttonList.add(new GCCoreGuiGradientButton(4, this.width / 2 + this.width / 3 - 65, this.height / 2 + this.height / 4 - 25, 50, 15, "Done"));
			...
			case DESIGN_FLAG:
				...
				this.sliderColorR = new GCCoreGuiSlider(1, flagDesignerRight + 10, guiTop + 10, availWidth, height, true, new Vector3(0, 0, 0), new Vector3(1, 0, 0));
				this.sliderColorG = new GCCoreGuiSlider(2, flagDesignerRight + 11 + availWidth, guiTop + 10, availWidth, height, true, new Vector3(0, 0, 0), new Vector3(0, 1, 0));
				this.sliderColorB = new GCCoreGuiSlider(3, flagDesignerRight + 12 + availWidth * 2, guiTop + 10, availWidth, height, true, new Vector3(0, 0, 0), new Vector3(0, 0, 1));
				this.checkboxShowFace = new GCCoreGuiCheckbox(4, this, this.width / 2 - this.width / 3 + 2, this.height / 2 + this.height / 4 - 16, "Show Face");
				...
				this.checkboxPaintbrush = new GCCoreGuiCheckbox(5, this, (int) (this.flagDesignerMinX - 15), this.height / 2 - this.height / 4 + 10, 13, 13, 26, 26, 133, 0, "", 4210752, false);
				this.checkboxEraser = new GCCoreGuiCheckbox(6, this, (int) (this.flagDesignerMinX - 15), this.height / 2 - this.height / 4 + 25, 13, 13, 26, 26, 133, 52, "", 4210752, false);
				this.checkboxSelector = new GCCoreGuiCheckbox(7, this, (int) (this.flagDesignerMinX - 15), this.height / 2 - this.height / 4 + 40, 13, 13, 26, 26, 133, 78, "", 4210752, false);
				this.checkboxColorSelector = new GCCoreGuiCheckbox(8, this, (int) (this.flagDesignerMinX - 15), this.height / 2 - this.height / 4 + 55, 13, 13, 26, 26, 133, 104, "", 4210752, false);
				this.checkboxShowGrid = new GCCoreGuiCheckbox(9, this, (int) (this.flagDesignerMinX - 15), this.height / 2 - this.height / 4 + 90, 13, 13, 26, 26, 133, 26, "", 4210752, false);
				this.sliderBrushSize = new GCCoreGuiSlider(10, checkboxPaintbrush.xPosition - 40, checkboxPaintbrush.yPosition, 35, 13, false, new Vector3(0.34, 0.34, 0.34), new Vector3(0.34, 0.34, 0.34), "Brush Size");
				this.sliderEraserSize = new GCCoreGuiSlider(11, checkboxEraser.xPosition - 40, checkboxEraser.yPosition, 35, 13, false, new Vector3(0.34, 0.34, 0.34), new Vector3(0.34, 0.34, 0.34), "Eraser Size");
