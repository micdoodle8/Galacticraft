 ...
 * 
 */
public class GuiSchematicInput extends GuiAdvancedContainer implements ISchematicResultPage
{
    ...
    public void initGui()
    {
        ...
        this.infoRegions.add(new InfoRegion((this.width - this.xSize) / 2 + 79, (this.height - this.ySize) / 2, 18, 18, schematicSlotDesc, this.width, this.height));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            case 1:
                ...
                break;
            case 2:
    			GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UNLOCK_NEW_SCHEMATIC, 0));
                break;
            }
        }
    }
