...
public class GuiAirLockController extends GuiScreen implements ICheckBoxCallback, IDropboxCallback, ITextBoxCallback
{
	...
	public void onSelectionChanged(GuiDropdown dropdown, int selection)
	{
		if (dropdown.equals(this.dropdownPlayerDistance))
		{
			...
			// PacketDispatcher.sendPacketToServer(PacketUtil.createPacket(GalacticraftCore.CHANNEL,
			// EnumPacketServer.ON_ADVANCED_GUI_CLICKED_INT, new Object[] { 2,
			// this.controller.xCoord, this.controller.yCoord,
			// this.controller.zCoord, this.controller.playerDistanceSelection
			// }));
		}
	}
	...
	public void onTextChanged(GuiTextBox textBox, String newText)
	{
		if (textBox.equals(this.textBoxPlayerToOpenFor))
		{
			...
			// PacketDispatcher.sendPacketToServer(PacketUtil.createPacket(GalacticraftCore.CHANNEL,
			// EnumPacketServer.ON_ADVANCED_GUI_CLICKED_STRING, new Object[] {
			// 0, this.controller.xCoord, this.controller.yCoord,
			// this.controller.zCoord, this.controller.playerToOpenFor }));
		}
	}
