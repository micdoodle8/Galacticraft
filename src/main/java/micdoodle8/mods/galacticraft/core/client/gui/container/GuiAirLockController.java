...
public class GuiAirLockController extends GuiScreen implements ICheckBoxCallback, IDropboxCallback, ITextBoxCallback
{
    ...
    public void onSelectionChanged(GuiElementCheckbox checkbox, boolean newSelected)
    {
        if (checkbox.equals(this.checkboxRedstoneSignal))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, mc.theWorld.provider.getDimension(), new Object[] { 0, this.controller.getPos(), this.controller.redstoneActivation ? 1 : 0 }));
        ...
        else if (checkbox.equals(this.checkboxPlayerDistance))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, mc.theWorld.provider.getDimension(), new Object[] { 1, this.controller.getPos(), this.controller.playerDistanceActivation ? 1 : 0 }));
            // PacketDispatcher.sendPacketToServer(PacketUtil.createPacket(GalacticraftCore.CHANNEL,
        ...
        else if (checkbox.equals(this.checkboxOpenForPlayer))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, mc.theWorld.provider.getDimension(), new Object[] { 3, this.controller.getPos(), this.controller.playerNameMatches ? 1 : 0 }));
            // PacketDispatcher.sendPacketToServer(PacketUtil.createPacket(GalacticraftCore.CHANNEL,
        ...
        else if (checkbox.equals(this.checkboxInvertSelection))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, mc.theWorld.provider.getDimension(), new Object[] { 4, this.controller.getPos(), this.controller.invertSelection ? 1 : 0 }));
            // PacketDispatcher.sendPacketToServer(PacketUtil.createPacket(GalacticraftCore.CHANNEL,
        ...
        else if (checkbox.equals(this.checkboxHorizontalMode))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, mc.theWorld.provider.getDimension(), new Object[] { 5, this.controller.getPos(), this.controller.horizontalModeEnabled ? 1 : 0 }));
            // PacketDispatcher.sendPacketToServer(PacketUtil.createPacket(GalacticraftCore.CHANNEL,
    ...
    public void onSelectionChanged(GuiElementDropdown dropdown, int selection)
    {
        if (dropdown.equals(this.dropdownPlayerDistance))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_INT, mc.theWorld.provider.getDimension(), new Object[] { 2, this.controller.getPos(), this.controller.playerDistanceSelection }));
        }
    }
    ...
    public void onTextChanged(GuiElementTextBox textBox, String newText)
    {
        if (textBox.equals(this.textBoxPlayerToOpenFor))
        {
            ...
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_ON_ADVANCED_GUI_CLICKED_STRING, mc.theWorld.provider.getDimension(), new Object[] { 0, this.controller.getPos(), this.controller.playerToOpenFor }));
        }
    }
