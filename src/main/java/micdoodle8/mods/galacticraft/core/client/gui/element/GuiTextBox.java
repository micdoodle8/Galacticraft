 ...
 * 
 */
public class GuiTextBox extends GuiButton
{
    public String text;
    ...
    public GuiTextBox(int id, ITextBoxCallback parentGui, int x, int y, int width, int height, String initialText, boolean numericOnly, int maxLength)
    {
