...
public class GCCoreOverlaySpaceship extends GCCoreOverlay
{
	...
	public static void renderSpaceshipOverlay(ResourceLocation guiTexture)
	{
		...
		resourcelocation = AbstractClientPlayer.getLocationSkin(GCCoreOverlaySpaceship.minecraft.thePlayer.getGameProfile().getName());
		AbstractClientPlayer.getDownloadImageSkin(resourcelocation, GCCoreOverlaySpaceship.minecraft.thePlayer.getGameProfile().getName());
