...
public class BMPDecoder {
   ...
   */
  public static BufferedImage read(BMPInfoHeader infoHeader, LittleEndianInputStream lis,
      BMPColorEntry[] colorTable) throws IOException {
   ...
   * @return the decoded image read from the source input
   */
  public static BufferedImage read1(BMPInfoHeader infoHeader,
   ...
   * @return the decoded image read from the source input
   */
  public static BufferedImage read4(BMPInfoHeader infoHeader,
      LittleEndianInputStream lis,
      BMPColorEntry[] colorTable) throws IOException {
   ...
   * @return the decoded image read from the source input
   */
  public static BufferedImage read8(BMPInfoHeader infoHeader,
      LittleEndianInputStream lis,
      BMPColorEntry[] colorTable) throws IOException {
    //1 byte per pixel
   ...
   * @return the decoded image read from the source input
   */
  public static BufferedImage read24(BMPInfoHeader infoHeader,
   ...
   * @return the decoded image read from the source input
   */
  public static BufferedImage read32(BMPInfoHeader infoHeader,
      LittleEndianInputStream lis) throws IOException {
    //4 bytes per pixel
    // blue 1
    // green 1
