...
//	public static Item cheeseBlock;
    ...
    public static void initItems()
    {
        ...
        GCItems.steelHelmet = new ItemArmorGC(EquipmentSlotType.HEAD, "helmet");
        GCItems.steelChestplate = new ItemArmorGC(EquipmentSlotType.CHEST, "chestplate");
        GCItems.steelLeggings = new ItemArmorGC(EquipmentSlotType.LEGS, "leggings");
        GCItems.steelBoots = new ItemArmorGC(EquipmentSlotType.FEET, "boots");
