 ...
 * 
 */
public abstract class ComponentMoonVillage extends StructureComponent
{
	static
	{
		try
	...
	protected ComponentMoonVillageStartPiece startPiece;

	public ComponentMoonVillage()
	{
	}

	protected ComponentMoonVillage(ComponentMoonVillageStartPiece par1ComponentVillageStartPiece, int par2)
	{
		super(par2);
	...
	protected StructureComponent getNextComponentNN(ComponentMoonVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random, int par4, int par5)
	{
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	protected StructureComponent getNextComponentPP(ComponentMoonVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random, int par4, int par5)
	{
		switch (this.coordBaseMode)
		{
		case 0:
