...
public class GCMoonComponentVillageWell extends GCMoonComponentVillage
{
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
	{
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, GCCoreBlocks.basicBlock, 4, Blocks.flowing_water, 0, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 15, 1, 4, 15, 4, GCCoreBlocks.basicBlock, 4, GCCoreBlocks.basicBlock, 4, false);
