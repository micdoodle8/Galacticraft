...
{
	public Class<? extends ComponentMoonVillage> villagePieceClass;
	public final int villagePieceWeight;
	public int villagePiecesSpawned;
	public int villagePiecesLimit;

	public StructureVillagePieceWeightMoon(Class<? extends ComponentMoonVillage> par1Class, int par2, int par3)
	{
