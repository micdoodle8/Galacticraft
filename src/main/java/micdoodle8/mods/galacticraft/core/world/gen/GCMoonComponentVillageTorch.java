...
public class GCMoonComponentVillageTorch extends GCMoonComponentVillage
{
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
	{
		...
		this.placeBlockAtCurrentPosition(par1World, GCCoreBlocks.unlitTorch, 15, 0, 3, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, GCCoreBlocks.unlitTorch, 15, 1, 3, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, GCCoreBlocks.unlitTorch, 15, 2, 3, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, GCCoreBlocks.unlitTorch, 15, 1, 3, -1, par3StructureBoundingBox);
		return true;
	}
}
