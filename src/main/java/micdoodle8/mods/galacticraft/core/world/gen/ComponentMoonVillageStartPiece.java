 ...
 * 
 */
public class ComponentMoonVillageStartPiece extends ComponentMoonVillageWell
{
	...
	public ComponentMoonVillageStartPiece()
	{
	}

	public ComponentMoonVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random, int par4, int par5, ArrayList<StructureVillagePieceWeightMoon> par6ArrayList, int par7)
	{
		super((ComponentMoonVillageStartPiece) null, 0, par3Random, par4, par5);
