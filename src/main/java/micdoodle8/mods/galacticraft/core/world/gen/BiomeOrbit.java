...
public class BiomeOrbit extends BiomeGC
{
    ...
    private BiomeOrbit()
    {
        super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.NOPE, STONE_STONE_GRAVEL_CONFIG).depth(0).scale(0).precipitation(Biome.RainType.NONE).category(Category.NONE).temperature(0.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent(null));
