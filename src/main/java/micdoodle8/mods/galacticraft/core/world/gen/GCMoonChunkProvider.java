...
import micdoodle8.mods.galacticraft.core.world.gen.dungeon.GCMoonRoomBoss;
import micdoodle8.mods.galacticraft.core.world.gen.dungeon.GCMoonRoomChests;
import micdoodle8.mods.galacticraft.core.world.gen.dungeon.GCMoonRoomEmpty;
import micdoodle8.mods.galacticraft.core.world.gen.dungeon.GCMoonRoomSpawner;
import micdoodle8.mods.galacticraft.core.world.gen.dungeon.GCMoonRoomTreasure;
...
{
	final Block topBlockID = GCCoreBlocks.blockMoon;
	final byte topBlockMeta = 5;
	final Block fillBlockID = GCCoreBlocks.blockMoon;
	final byte fillBlockMeta = 3;
	final Block lowerBlockID = GCCoreBlocks.blockMoon;
	...
	private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(GCCoreBlocks.blockMoon, 14, 8, 16, 3);
