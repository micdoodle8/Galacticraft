...
//        this.setBlockState(par1World, GCBlocks.glowstoneTorch.getDefaultState().with(BlockGlowstoneTorch.FACING, this.getCoordBaseMode().rotateYCCW()), 14, yLevel, 8, par3StructureBoundingBox);
...
//        this.setBlockState(par1World, GCBlocks.glowstoneTorch.getDefaultState().with(BlockGlowstoneTorch.FACING, this.getCoordBaseMode().rotateY()), 2, yLevel, 8, par3StructureBoundingBox);
//
//        yLevel = 5;
//
//        // corner 1
