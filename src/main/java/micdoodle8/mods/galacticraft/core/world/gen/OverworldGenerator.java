...
public class OverworldGenerator implements IWorldGenerator
{
    ...
    private boolean generateOre(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        double var7 = par3 + 8 + (float)Math.sin(var6) * this.amountPerVein / 8.0F;
        double var9 = par3 + 8 - (float)Math.sin(var6) * this.amountPerVein / 8.0F;
        double var11 = par5 + 8 + (float)Math.cos(var6) * this.amountPerVein / 8.0F;
        double var13 = par5 + 8 - (float)Math.cos(var6) * this.amountPerVein / 8.0F;
        ...
        for (int var19 = 0; var19 <= this.amountPerVein; ++var19)
        {
            ...
            double var28 = ((float)Math.sin(var19 * (float) Math.PI / this.amountPerVein) + 1.0F) * var26 + 1.0D;
            double var30 = ((float)Math.sin(var19 * (float) Math.PI / this.amountPerVein) + 1.0F) * var26 + 1.0D;
