...
//
//        if (var7.isVecInside(new BlockPos(var9, var10, var11)) && var1.getBlockState(new BlockPos(var9, var10, var11)).getBlock() != Blocks.SPAWNER)
//        {
//            var1.setBlockState(new BlockPos(var9, var10, var11), Blocks.SPAWNER.getDefaultState(), 2);
