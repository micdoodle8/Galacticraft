...
//        this.setBlockState(par1World, GCBlocks.basicBlock.getStateFromMeta(4), 5, yLevel, 1, par3StructureBoundingBox);
//
//        this.setBlockState(par1World, GCBlocks.glowstoneTorch.getDefaultState().with(BlockGlowstoneTorch.FACING, this.getCoordBaseMode()), 8, yLevel, 2, par3StructureBoundingBox);
//        this.setBlockState(par1World, GCBlocks.glowstoneTorch.getDefaultState().with(BlockGlowstoneTorch.FACING, this.getCoordBaseMode().rotateY()), 14, yLevel, 8, par3StructureBoundingBox);
//        this.setBlockState(par1World, GCBlocks.glowstoneTorch.getDefaultState().with(BlockGlowstoneTorch.FACING, this.getCoordBaseMode().getOpposite()), 8, yLevel, 14, par3StructureBoundingBox);
//        this.setBlockState(par1World, GCBlocks.glowstoneTorch.getDefaultState().with(BlockGlowstoneTorch.FACING, this.getCoordBaseMode().rotateYCCW()), 2, yLevel, 8, par3StructureBoundingBox);
//
//        yLevel = 5;
//
//        // corner 1
