...
//            if (nbt != null)
//            {
//                int tileX = nbt.getInt("ChunkLoaderTileX");
//                int tileY = nbt.getInt("ChunkLoaderTileY");
//                int tileZ = nbt.getInt("ChunkLoaderTileZ");
...
//        }
//
//        HashSet<BlockPos> chunkLoaders = dimensionMap.get(world.getDimension().getType());
//
