...
public class GCMoonBiomeDecorator
{
	...
	{
		this.copperGen = new GCCoreWorldGenMinableMeta(GCCoreBlocks.blockMoon, 4, 0, true, GCCoreBlocks.blockMoon, 4);
		this.tinGen = new GCCoreWorldGenMinableMeta(GCCoreBlocks.blockMoon, 4, 1, true, GCCoreBlocks.blockMoon, 4);
		this.cheeseGen = new GCCoreWorldGenMinableMeta(GCCoreBlocks.blockMoon, 3, 2, true, GCCoreBlocks.blockMoon, 4);
		this.dirtGen = new GCCoreWorldGenMinableMeta(GCCoreBlocks.blockMoon, 32, 3, true, GCCoreBlocks.blockMoon, 4);
	}
