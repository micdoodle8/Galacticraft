...
public class BiomeDecoratorMoon
{
	...
	void generateMoon()
	{
		...
		if (!ConfigManagerCore.disableCopperMoon) this.genStandardOre1(26, this.copperGen, 0, 60);
		if (!ConfigManagerCore.disableTinMoon) this.genStandardOre1(23, this.tinGen, 0, 60);
		if (!ConfigManagerCore.disableCheeseMoon) this.genStandardOre1(12, this.cheeseGen, 0, 128);
