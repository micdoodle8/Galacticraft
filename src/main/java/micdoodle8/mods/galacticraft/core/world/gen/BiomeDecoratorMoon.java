...
public class BiomeDecoratorMoon
{
	...
	{
		MinecraftForge.EVENT_BUS.post(new EventWorldPopulate.Pre(this.worldObj, this.randomGenerator, this.chunkX, this.chunkZ));
		...
		MinecraftForge.EVENT_BUS.post(new EventWorldPopulate.Post(this.worldObj, this.randomGenerator, this.chunkX, this.chunkZ));
	}
}
