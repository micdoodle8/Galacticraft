...
*/
    ...
    private static void addIndustrialCraft2Recipes()
    {
        ...
        Recipes.macerator.addRecipe(new RecipeInputItemStack(new ItemStack(GCBlocks.basicBlock, 1, 7), 1), null, false, new ItemStack(GCItems.ic2compat, 2, 0));
        Recipes.macerator.addRecipe(new RecipeInputItemStack(new ItemStack(GCItems.basicItem, 1, 5), 1), null, false, new ItemStack(GCItems.ic2compat, 1, 2));
        Recipes.macerator.addRecipe(new RecipeInputItemStack(new ItemStack(GCItems.basicItem, 1, 8), 1), null, false, new ItemStack(GCItems.ic2compat, 1, 2));
        ...
        Recipes.oreWashing.addRecipe(new RecipeInputItemStack(new ItemStack(GCItems.ic2compat, 1, 0), 1), amountTag, false, new ItemStack [] { new ItemStack(GCItems.ic2compat, 1, 1), dustSmallIron, dustStone });
        ...
        Recipes.centrifuge.addRecipe(new RecipeInputItemStack(new ItemStack(GCItems.ic2compat, 1, 1), 1), heatTag1, false, new ItemStack [] { dustSmallTitanium, new ItemStack(GCItems.ic2compat, 1, 2) });
        NBTTagCompound heatTag2 = new NBTTagCompound();
        heatTag2.setInteger("minHeat", 750);
        Recipes.centrifuge.addRecipe(new RecipeInputItemStack(new ItemStack(GCItems.ic2compat, 1, 0), 1), heatTag1, false, new ItemStack [] { dustSmallIron, new ItemStack(GCItems.ic2compat, 1, 2), dustStone });
