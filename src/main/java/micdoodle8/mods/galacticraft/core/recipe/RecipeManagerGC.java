...
public class RecipeManagerGC
{
    ...
    private static void addUniversalRecipes()
    {
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.screen), new Object[] { "XYX", "YGY", "XWX", 'W', "waferAdvanced", 'X', "compressedSteel", 'Y', "waferBasic", 'G', Blocks.glass });
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.basicBlock, 1, 12), new Object[] { "YYY", "YYY", "YYY", 'Y', GCItems.meteoricIronIngot });
