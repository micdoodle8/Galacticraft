...
//    {
//        if (this.player.world.getDimension() instanceof IZeroGDimension)
//        {
...
//            if ((aABB.minY % 1D) == 0.5D) this.player.setBoundingBox(aABB.offset(0D, 0.00001D, 0D));
//        }
//    }
//
//    @Override
...
//
//        if (CompatibilityManager.isSmartMovingLoaded && !this.player.abilities.isFlying)
//        {
