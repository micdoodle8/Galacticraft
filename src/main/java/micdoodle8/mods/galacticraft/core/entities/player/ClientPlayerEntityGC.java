...
//                }
    ...
    private void playShoulderEntityAmbientSound(@Nullable CompoundNBT p_192028_1_)
    {
        if (p_192028_1_ != null && !p_192028_1_.contains("Silent") || !p_192028_1_.getBoolean("Silent"))
        {
            ...
            EntityType.byKey(s).filter((p_213830_0_) -> p_213830_0_ == EntityType.PARROT).ifPresent((p_213834_1_) -> ParrotEntity.playAmbientSound(this.world, this));
        }
...
//
    ...
    public ResourceLocation getLocationCape()
    {
        ...
        if ((ConfigManagerCore.INSTANCE.overrideCapes.get() || vanillaCape == null) && galacticraftCape != null)
        {
