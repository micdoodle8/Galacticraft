...
//        case 14:
//        case 15:
//            if (ConfigManagerCore.INSTANCE.challengeMobDropsAndSpawning) this.dropItem(Items.MELON_SEEDS, 1);
//            break;
//        }
//    }
//
...
//        if (wasRecentlyHit && (ConfigManagerCore.INSTANCE.challengeMobDropsAndSpawning) && j > 0 && this.rand.nextInt(6) <= (lootingModifier + 1) / 2)
