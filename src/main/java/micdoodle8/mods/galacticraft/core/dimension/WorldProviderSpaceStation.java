 ...
 * 
 */
public class WorldProviderSpaceStation extends WorldProvider implements IOrbitDimension, ISolarLevel, IExitHeight
{
	...
	{
		return new ChunkProviderSpaceStation(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
	}
