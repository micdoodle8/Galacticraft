...
public class GCCreativeTab extends CreativeTabs
{
	...
	public GCCreativeTab(int par1, String par2Str, Item itemForTab, int metaForTab)
	{
		super(par1, par2Str);
	...
	public GCCreativeTab(int par1, String par2Str, Block itemForTab, int metaForTab)
	{
