...
//Server side
            ...
            ConfigManagerCore.sealableIDs = ConfigManagerCore.configuration.get(Constants.CONFIG_CATEGORY_GENERAL, "External Sealable IDs", new String[] { String.valueOf(GameData.blockRegistry.getNameForObject(Blocks.glass_pane) + ":0") }, "List names of non-opaque blocks from other mods (for example, special types of glass) that the Oxygen Sealer should recognize as solid seals. Format is NAME:METADATA").getStringList();
            ConfigManagerCore.detectableIDs = ConfigManagerCore.configuration.get(Constants.CONFIG_CATEGORY_GENERAL, "External Detectable IDs", new String[] { String.valueOf(GameData.blockRegistry.getNameForObject(Blocks.coal_ore) + ":0"), String.valueOf(GameData.blockRegistry.getNameForObject(Blocks.diamond_ore) + ":0"), String.valueOf(GameData.blockRegistry.getNameForObject(Blocks.gold_ore) + ":0"), String.valueOf(GameData.blockRegistry.getNameForObject(Blocks.iron_ore) + ":0"), String.valueOf(GameData.blockRegistry.getNameForObject(Blocks.lapis_ore) + ":0"), String.valueOf(GameData.blockRegistry.getNameForObject(Blocks.redstone_ore) + ":0"), String.valueOf(GameData.blockRegistry.getNameForObject(Blocks.lit_redstone_ore) + ":0") }, "List names from other mods that the Sensor Glasses should recognize as solid blocks. Format is NAME:METADATA").getStringList();
