...
public class ConfigManagerCore
{
	...
	public static void setDefaultValues(File file)
	{
		...
		try
		{
			...
			ConfigManagerCore.idDimensionOverworldOrbit = ConfigManagerCore.configuration.get("DIMENSIONS", "Overworld Orbit Dimension ID", -27).getInt(-27);
			ConfigManagerCore.dimensionIDMoon = ConfigManagerCore.configuration.get("DIMENSIONS", "Moon Dimension ID", -28).getInt(-28);
			...
			ConfigManagerCore.disableTinMoon = ConfigManagerCore.configuration.get(Configuration.CATEGORY_GENERAL, "Disable Cheese Ore Gen on Moon", false).getBoolean(false);
			ConfigManagerCore.disableCopperMoon = ConfigManagerCore.configuration.get(Configuration.CATEGORY_GENERAL, "Disable Cheese Ore Gen on Moon", false).getBoolean(false);
