		...
		if (astring.length > 0)
		{
			...
			try
			{
				...
				if (playerBase != null)
				{
					...
					{
						final SpaceStationSaveData data = SpaceStationSaveData.getStationData(playerBase.worldObj, playerBase.getSpaceStationDimensionID(), playerBase);
					...
					final GCEntityPlayerMP playerToAdd = PlayerUtil.getPlayerBaseServerFromPlayerUsername(var3);
