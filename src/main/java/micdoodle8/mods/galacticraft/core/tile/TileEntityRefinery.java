...
public class TileEntityRefinery extends TileBaseElectricBlockWithInventory implements ISidedInventory, IFluidHandlerWrapper
{
    ...
    {
        super(TYPE);
        this.storage.setMaxExtract(ConfigManagerCore.INSTANCE.hardMode.get() ? 90 : 60);
    ...
    public void smeltItem()
    {
        if (this.canProcess())
        {
            ...
            this.fuelTank.fill(new FluidStack(GCFluids.FUEL.getFluid(), amountToDrain)/*FluidRegistry.getFluidStack(ConfigManagerCore.INSTANCE.useOldFuelFluidID ? "fuelgc" : "fuel", amountToDrain)*/, IFluidHandler.FluidAction.EXECUTE);
        }
    }
