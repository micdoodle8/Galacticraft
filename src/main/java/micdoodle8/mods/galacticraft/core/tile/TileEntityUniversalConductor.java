...
public abstract class TileEntityUniversalConductor extends TileEntityConductor
{
	...
	// this.getNetwork()).getRequest(this).getWatts() *
	// NetworkConfigHandler.TO_IC2_RATIO;
	// }
	//
	// @RuntimeInterface(clazz = "ic2.api.energy.tile.IEnergySink", modID =
	// "IC2")
	// public double injectEnergyUnits(ForgeDirection directionFrom, double
	// amount)
	// {
	// TileEntity tile = new
	// Vector3(this).modifyPositionFromSide(directionFrom).getTileEntity(this.worldObj);
	// ElectricityPack pack = ElectricityPack.getFromWatts((float) (amount *
	// NetworkConfigHandler.IC2_RATIO), 120);
	// return ((IElectricityNetwork) this.getNetwork()).produce(pack, true,
	// this, tile) * NetworkConfigHandler.TO_IC2_RATIO;
	// }
	//
	// @RuntimeInterface(clazz = "ic2.api.energy.tile.IEnergySink", modID =
	// "IC2")
	...
	// {
	// if (this.getNetwork() == null || ((IElectricityNetwork)
	// this.getNetwork()).getRequest(this).getWatts() <= 0.0F)
	// {
	// return null;
	// }
	//
	...
	// {
	// float requiredEnergy = ((IElectricityNetwork)
	// this.getNetwork()).getRequest(this).getWatts() *
	// NetworkConfigHandler.TO_BC_RATIO;
	// ((PowerHandler) this.powerHandler).configure(1, requiredEnergy, 0,
	// requiredEnergy);
	// }
	//
	// @RuntimeInterface(clazz = "buildcraft.api.power.IPowerReceptor", modID =
	...
	// if (this.getNetwork() != null)
	// {
	// ElectricityPack pack = ElectricityPack.getFromWatts(((PowerHandler)
	// this.powerHandler).getEnergyStored() * NetworkConfigHandler.BC3_RATIO,
	// 120);
	...
	// simulate)
	// {
	// return maxReceive - (int) Math.floor(((IElectricityNetwork)
	// this.getNetwork()).produce(ElectricityPack.getFromWatts(maxReceive *
	// NetworkConfigHandler.TE_RATIO, 120), !simulate, this) *
	...
	// }
	//
	// return (int) Math.floor(((IElectricityNetwork)
	// this.getNetwork()).getRequest(this).getWatts() *
	// NetworkConfigHandler.TO_TE_RATIO);
	// }
	//
	// @RuntimeInterface(clazz = "mekanism.api.energy.IStrictEnergyAcceptor",
	// modID = "Mekanism")
	// public double transferEnergyToAcceptor(ForgeDirection side, double
	// amount)
	// {
	...
	// }
	//
	// return amount - ((IElectricityNetwork)
	// this.getNetwork()).produce(ElectricityPack.getFromWatts((float) (amount *
	// NetworkConfigHandler.MEKANISM_RATIO), 120), true, this) *
	// NetworkConfigHandler.TO_MEKANISM_RATIO;
	// }
	//
	// @RuntimeInterface(clazz = "mekanism.api.energy.IStrictEnergyAcceptor",
	// modID = "Mekanism")
