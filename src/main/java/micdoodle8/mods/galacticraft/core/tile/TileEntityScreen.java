...
public class TileEntityScreen extends TileEntityAdvanced implements ITileClientUpdates
{
    ...
    public void setVerifiedConnectedUp(BlockVec3 vec)
    {
        ...
        TileEntity tileUp = vec.getTileEntityOnSide(this.worldObj, 1);
    ...
    {
        int meta = this.getBlockMetadata() & 7;
        TileEntity tileDown = vec.getTileEntityOnSide(this.worldObj, 0);
    ...
    public void setVerifiedConnectedLeft(BlockVec3 vec)
    {
        ...
        TileEntity tileLeft = vec.getTileEntityOnSide(this.worldObj, side);
    ...
    public void setVerifiedConnectedRight(BlockVec3 vec)
    {
        ...
        TileEntity tileRight = vec.getTileEntityOnSide(this.worldObj, side);
