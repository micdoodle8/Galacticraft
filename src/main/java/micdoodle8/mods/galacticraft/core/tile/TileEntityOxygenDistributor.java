...
/**
 * TileEntityOxygenDistributor.java
 * 
 ...
 * 
 */
public class TileEntityOxygenDistributor extends TileEntityOxygen implements IInventory, ISidedInventory
{
	...
	{
		super(TileEntityOxygenDistributor.WATTS_PER_TICK, 50, 6000, 16);
	}
