...
public class GCCoreTileEntityLandingPadSingle extends TileEntity
{
	...
	public void updateEntity()
	{
		...
		if (attachedLaunchPads.size() == 9)
		{
			...
			this.worldObj.setBlock(this.xCoord, this.yCoord, this.zCoord, GCCoreBlocks.landingPadFull, 0, 3);
			final GCCoreTileEntityLandingPad tile = (GCCoreTileEntityLandingPad) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord);
