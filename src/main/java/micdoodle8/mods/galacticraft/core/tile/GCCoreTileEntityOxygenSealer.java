...
public class GCCoreTileEntityOxygenSealer extends GCCoreTileEntityOxygen implements IInventory, ISidedInventory
{
	...
	public int getFindSealChecks()
	{
		...
		if (blockAbove != Blocks.air && blockAbove != GCCoreBlocks.breatheableAir && !OxygenPressureProtocol.canBlockPassAir(this.worldObj, Block.getIdFromBlock(blockAbove), new BlockVec3(this.xCoord, this.yCoord + 1, this.zCoord), 0))
		{
			// The vent is blocked
			return 0;
		}
