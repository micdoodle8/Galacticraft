...
//		IngotCompressorRecipeHandler.efuels.add(Block.mushroomCapBrown);
//		IngotCompressorRecipeHandler.efuels.add(Block.mushroomCapRed);
//		IngotCompressorRecipeHandler.efuels.add(Block.signPost);
//		IngotCompressorRecipeHandler.efuels.add(Block.signWall);
//		IngotCompressorRecipeHandler.efuels.add(Block.doorWood);
//		IngotCompressorRecipeHandler.efuels.add(Block.lockedChest);
//	}
//
...
//		{
//			if (!IngotCompressorRecipeHandler.efuels.contains(item))
//			{
