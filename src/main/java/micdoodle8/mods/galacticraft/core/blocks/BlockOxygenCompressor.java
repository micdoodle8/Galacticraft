...
public class BlockOxygenCompressor extends BlockAdvancedTile
{
	...
	{
		par3List.add(new ItemStack(par1, 1, BlockOxygenCompressor.OXYGEN_COMPRESSOR_METADATA));
		par3List.add(new ItemStack(par1, 1, BlockOxygenCompressor.OXYGEN_DECOMPRESSOR_METADATA));
	}
