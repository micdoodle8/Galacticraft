 ...
 * 
 */
public class BlockOxygenPipe extends BlockTransmitter
{
	...
	public IIcon getIcon(IBlockAccess par1IBlockAccess, int x, int y, int z, int par5)
	{
		...
		if (block == GCBlocks.oxygenPipe && ((TileEntityOxygenPipe) thisVec.getTileEntity(par1IBlockAccess)).getColor() == tileEntity.getColor())
		{
