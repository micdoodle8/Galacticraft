...
public class GCCoreBlockAirLockFrame extends GCCoreBlockAdvancedTile
{
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
	{
		...
		{
			((GCCoreTileEntityAirLockController) tile).ownerName = ((EntityPlayer) entityLiving).getGameProfile().getName();
		}
	}
	...
	{
		if (world.getBlockMetadata(par2, par3, par4) >= GCCoreBlockAirLockFrame.METADATA_AIR_LOCK_CONTROLLER)
		{
