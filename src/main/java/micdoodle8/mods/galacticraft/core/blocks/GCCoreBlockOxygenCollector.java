...
public class GCCoreBlockOxygenCollector extends GCCoreBlockAdvancedTile
{
	...
	{
		if (par1World.getTileEntity(x, y, z) instanceof GCCoreTileEntityOxygenCollector)
		{
			if (((GCCoreTileEntityOxygenCollector) par1World.getTileEntity(x, y, z)).lastOxygenCollected > 1)
			{
