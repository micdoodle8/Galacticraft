...
public class GCCoreBlockOxygenCompressor extends GCCoreBlockAdvancedTile
{
	...
	{
		par3List.add(new ItemStack(this, 1, GCCoreBlockOxygenCompressor.OXYGEN_COMPRESSOR_METADATA));
		par3List.add(new ItemStack(this, 1, GCCoreBlockOxygenCompressor.OXYGEN_DECOMPRESSOR_METADATA));
	}
