...
public class GCCoreBlockFallenMeteor extends Block implements ITileEntityProvider
{
	...
	private void tryToFall(World par1World, int par2, int par3, int par4)
	{
		...
		{
			int prevHeatLevel = ((GCCoreTileEntityFallenMeteor) par1World.getTileEntity(par2, par3, par4)).getHeatLevel();
			...
			if (par3 > 0)
			{
				...
				((GCCoreTileEntityFallenMeteor) par1World.getTileEntity(par2, par3, par4)).setHeatLevel(prevHeatLevel);
			}
		}
	}
