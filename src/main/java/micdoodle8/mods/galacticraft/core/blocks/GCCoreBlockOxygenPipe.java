...
public class GCCoreBlockOxygenPipe extends GCCoreBlockTransmitter
{
	...
	{
		final TileEntityOxygenPipe tile = (TileEntityOxygenPipe) par1World.getBlockTileEntity(par2, par3, par4);
	...
	public Icon getBlockTexture(IBlockAccess par1IBlockAccess, int x, int y, int z, int par5)
	{
		...
		final int idAtSide = thisVec.getBlock(par1IBlockAccess);

		final TileEntityOxygenPipe tileEntity = (TileEntityOxygenPipe) par1IBlockAccess.getBlockTileEntity(x, y, z);

		if (idAtSide == GCCoreBlocks.oxygenPipe.blockID && ((TileEntityOxygenPipe) thisVec.getTileEntity(par1IBlockAccess)).getColor() == tileEntity.getColor())
		{
	...
	{
		final TileEntityOxygenPipe tileEntity = (TileEntityOxygenPipe) par1World.getBlockTileEntity(x, y, z);
