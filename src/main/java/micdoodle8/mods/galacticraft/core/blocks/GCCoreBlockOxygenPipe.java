...
public class GCCoreBlockOxygenPipe extends GCCoreBlockTransmitter
{
	...
	{
		final GCCoreTileEntityOxygenPipe tile = (GCCoreTileEntityOxygenPipe) par1World.getTileEntity(par2, par3, par4);
	...
	public IIcon getIcon(IBlockAccess par1IBlockAccess, int x, int y, int z, int par5)
	{
		...
		final GCCoreTileEntityOxygenPipe tileEntity = (GCCoreTileEntityOxygenPipe) par1IBlockAccess.getTileEntity(x, y, z);

		if (blockAt == GCCoreBlocks.oxygenPipe && ((GCCoreTileEntityOxygenPipe) thisVec.getTileEntity(par1IBlockAccess)).getColor() == tileEntity.getColor())
		{
	...
	{
		final GCCoreTileEntityOxygenPipe tileEntity = (GCCoreTileEntityOxygenPipe) par1World.getTileEntity(x, y, z);
