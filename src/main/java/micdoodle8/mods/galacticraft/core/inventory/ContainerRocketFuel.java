 ...
 * 
 */
public class ContainerRocketFuel extends Container
{
	private final IInventory lowerChestInventory;
	private final IInventory spaceshipInv;
	private final EnumRocketType rocketType;

	public ContainerRocketFuel(IInventory par1IInventory, IInventory par2IInventory, EnumRocketType rocketType)
	{
