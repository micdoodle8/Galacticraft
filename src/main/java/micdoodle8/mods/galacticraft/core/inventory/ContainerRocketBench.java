 ...
 * 
 */
public class ContainerRocketBench extends Container
{
	public InventoryNasaWorkbench craftMatrix = new InventoryNasaWorkbench(this);
	public IInventory craftResult = new InventoryCraftResult();
	private final World worldObj;

	public ContainerRocketBench(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
	{
		final int change = 27;
		this.worldObj = par1InventoryPlayer.player.worldObj;
		this.addSlotToContainer(new SlotSchematicResult(par1InventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 142, 69 + change));
		int var6;
		int var7;
