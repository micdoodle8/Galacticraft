 ...
 * 
 */
public class GCCoreSlotBuggyBench extends Slot
{
	private final int index;
	private final int x, y, z;
	private final EntityPlayer player;

	public GCCoreSlotBuggyBench(IInventory par2IInventory, int par3, int par4, int par5, int x, int y, int z, EntityPlayer player)
	{
	...
	public boolean isItemValid(ItemStack par1ItemStack)
	{
		...
		{
		case 1:
			return par1ItemStack.getItem() == GCCoreItems.heavyPlatingTier1 ? true : false;
		case 2:
			return par1ItemStack.getItem() == GCCoreItems.heavyPlatingTier1 ? true : false;
		case 3:
			return par1ItemStack.getItem() == GCCoreItems.heavyPlatingTier1 ? true : false;
		...
		case 5:
			return par1ItemStack.getItem() == GCCoreItems.heavyPlatingTier1 ? true : false;
		case 6:
			return par1ItemStack.getItem() == GCCoreItems.partBuggy && par1ItemStack.getItemDamage() == 1 ? true : false;
		case 7:
			return par1ItemStack.getItem() == GCCoreItems.heavyPlatingTier1 ? true : false;
		case 8:
			return par1ItemStack.getItem() == GCCoreItems.heavyPlatingTier1 ? true : false;
		...
		case 12:
			return par1ItemStack.getItem() == GCCoreItems.heavyPlatingTier1 ? true : false;
		case 13:
			return par1ItemStack.getItem() == GCCoreItems.partBuggy && par1ItemStack.getItemDamage() == 0 ? true : false;
		case 14:
			return par1ItemStack.getItem() == GCCoreItems.partBuggy && par1ItemStack.getItemDamage() == 0 ? true : false;
		case 15:
			return par1ItemStack.getItem() == GCCoreItems.partBuggy && par1ItemStack.getItemDamage() == 0 ? true : false;
		case 16:
			return par1ItemStack.getItem() == GCCoreItems.partBuggy && par1ItemStack.getItemDamage() == 0 ? true : false;
		case 17:
			return par1ItemStack.getItem() == GCCoreItems.partBuggy && par1ItemStack.getItemDamage() == 2 ? true : false;
		case 18:
			return par1ItemStack.getItem() == GCCoreItems.partBuggy && par1ItemStack.getItemDamage() == 2 ? true : false;
		case 19:
			return par1ItemStack.getItem() == GCCoreItems.partBuggy && par1ItemStack.getItemDamage() == 2 ? true : false;
