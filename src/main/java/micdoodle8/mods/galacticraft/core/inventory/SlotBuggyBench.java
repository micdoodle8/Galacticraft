        ...
        if (this.player instanceof EntityPlayerMP)
        {
            for (int var12 = 0; var12 < this.player.world.playerEntities.size(); ++var12)
            {
                ...
                if (var13.dimension == GCCoreUtil.getDimensionID(this.player.world))
                {
                    ...
                    {
                        GalacticraftCore.packetPipeline.sendTo(new PacketSimple(EnumSimplePacket.C_SPAWN_SPARK_PARTICLES, GCCoreUtil.getDimensionID(var13.world), new Object[] { this.pos }), var13);
                    }
                }
            }
        }
