...
public class SlotRocketBench extends Slot
{
	...
	public boolean isItemValid(ItemStack itemStack)
	{
		...
		{
		case 1:
			return itemStack.getItem() == GCItems.partNoseCone ? true : false;
		case 2:
		...
		case 9:
			return itemStack.getItem() == GCItems.heavyPlatingTier1 ? true : false;
		case 10:
			return itemStack.getItem() == GCItems.partFins ? true : false;
		case 11:
			return itemStack.getItem() == GCItems.partFins ? true : false;
		case 12:
			return itemStack.getItem() == GCItems.rocketEngine && itemStack.getItemDamage() == 0 ? true : false;
		case 13:
			return itemStack.getItem() == GCItems.partFins ? true : false;
		case 14:
			return itemStack.getItem() == GCItems.partFins ? true : false;
