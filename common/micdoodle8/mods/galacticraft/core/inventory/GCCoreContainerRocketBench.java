...
public class GCCoreContainerRocketBench extends Container
{
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par1)
    {
        ...
        if (var3 != null && var3.getHasStack())
        {
            ...
            else if (var2.getItem().itemID == GCCoreItems.rocketNoseCone.itemID && !((Slot) this.inventorySlots.get(1)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.heavyPlating.itemID && !((Slot) this.inventorySlots.get(2)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.heavyPlating.itemID && !((Slot) this.inventorySlots.get(3)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.heavyPlating.itemID && !((Slot) this.inventorySlots.get(4)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.heavyPlating.itemID && !((Slot) this.inventorySlots.get(5)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.heavyPlating.itemID && !((Slot) this.inventorySlots.get(6)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.heavyPlating.itemID && !((Slot) this.inventorySlots.get(7)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.heavyPlating.itemID && !((Slot) this.inventorySlots.get(8)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.heavyPlating.itemID && !((Slot) this.inventorySlots.get(9)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.rocketFins.itemID && !((Slot) this.inventorySlots.get(10)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.rocketFins.itemID && !((Slot) this.inventorySlots.get(11)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.rocketFins.itemID && !((Slot) this.inventorySlots.get(13)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GCCoreItems.rocketFins.itemID && !((Slot) this.inventorySlots.get(14)).getHasStack())
            {
