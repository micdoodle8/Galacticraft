...
public class GCCoreBlockSolar extends BlockTile
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.icons[5] = par1IconRegister.registerIcon(GalacticraftCore.TEXTURE_PREFIX + "machine_power_input");
    ...
    {
        entityPlayer.openGui(GalacticraftCore.instance, GCCoreConfigManager.idGuiSolarPanel, world, x, y, z);
        return true;
    }
