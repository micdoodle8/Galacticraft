...
public abstract class GCCoreBlockConductor extends BlockContainer
{
	...
	public GCCoreBlockConductor(int id, Material material)
	{
		super(id, material);
	}
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z)
	{
		if (this.isWireCollision)
		{
			...
			if (tileEntity instanceof GCCoreTileEntityConductor)
			{
				TileEntity[] connectable = ((GCCoreTileEntityConductor) tileEntity).getAdjacentConnections();
