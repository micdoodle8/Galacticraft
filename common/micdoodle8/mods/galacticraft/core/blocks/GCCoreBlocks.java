...
public class GCCoreBlocks
{
    ...
    public static void initBlocks()
    {
        ...
        GCCoreBlocks.airDistributor = (GCCoreBlockOxygenDistributor) new GCCoreBlockOxygenDistributor(GCCoreConfigManager.idBlockAirDistributor).setHardness(1.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("distributor");
        ...
        GCCoreBlocks.blockAirCollector = new GCCoreBlockOxygenCollector(GCCoreConfigManager.idBlockAirCollector).setHardness(1.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("oxygenCollector");
        ...
        GCCoreBlocks.decorationBlocks = new GCCoreBlock(GCCoreConfigManager.idBlockDecorationBlock).setHardness(1.0F).setUnlocalizedName("decorationblock");
        GCCoreBlocks.airLockFrame = new GCCoreBlockAirLockFrame(GCCoreConfigManager.idBlockAirLockFrame).setHardness(1.0F).setStepSound(Block.soundMetalFootstep).setUnlocalizedName("airLockFrame");
        ...
        GCCoreBlocks.refinery = new GCCoreBlockRefinery(GCCoreConfigManager.idBlockRefinery, 0).setHardness(1.0F).setStepSound(Block.soundMetalFootstep).setUnlocalizedName("refinery");
        GCCoreBlocks.compressor = new GCCoreBlockOxygenCompressor(GCCoreConfigManager.idBlockAirCompressor, false).setHardness(1.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("oxygenCompressor");
        GCCoreBlocks.fuelLoader = new GCCoreBlockFuelLoader(GCCoreConfigManager.idBlockFuelLoader).setHardness(1.0F).setStepSound(Block.soundMetalFootstep).setUnlocalizedName("fuelLoader");
        ...
        GCCoreBlocks.sealer = new GCCoreBlockOxygenSealer(GCCoreConfigManager.idBlockOxygenSealer).setHardness(1.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("sealer");
        GCCoreBlocks.enclosedWire = new GCCoreBlockEnclosed(GCCoreConfigManager.idBlockEnclosedWire).setHardness(0.4F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("enclosed");
        GCCoreBlocks.oxygenDetector = new GCCoreBlockOxygenDetector(GCCoreConfigManager.idBlockOxygenDetector).setHardness(1.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("oxygenDetector");
        GCCoreBlocks.cargoLoader = new GCCoreBlockCargoLoader(GCCoreConfigManager.idBlockCargoLoader).setHardness(1.0F).setStepSound(Block.soundMetalFootstep).setUnlocalizedName("cargo");
        ...
        GCCoreBlocks.solarPanel = new GCCoreBlockSolar(GCCoreConfigManager.idBlockSolarPanel).setHardness(1.0F).setStepSound(Block.soundMetalFootstep).setUnlocalizedName("solar");
        GCCoreBlocks.blockMachineBase = new GCCoreBlockBasicMachine(GCCoreConfigManager.idBlockBasicMachine).setHardness(1.0F).setStepSound(Block.soundMetalFootstep).setUnlocalizedName("machine");
