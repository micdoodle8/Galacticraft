...
public class GCCoreBlockAirLockFrame extends BlockContainer implements ITileEntityProvider
{
    ...
    private boolean gettingPowered(World par1World, int x, int y, int z)
    {
        ...
        //
        // if (par1World.isBlockIndirectlyGettingPowered(x - var1, y, z - var2)
        // || par1World.isBlockIndirectlyGettingPowered(x + var1, y, z + var2))
        // {
        // return false;
        // }
        // }
    ...
    // var2 = airLock.orientation;
    //
    // if (OxygenUtil.isBlockGettingOxygen(par1World, x - var1, y, z - var2) ||
    // OxygenUtil.isBlockGettingOxygen(par1World, x + var1, y, z + var2))
    // {
    // return false;
    // }
    // }
