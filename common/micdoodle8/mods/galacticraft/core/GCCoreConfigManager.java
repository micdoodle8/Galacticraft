...
public class GCCoreConfigManager
{
	...
	public static void setDefaultValues(File file)
	{
		...
		try
		{
			...
			GCCoreConfigManager.enableSealerMultithreading = GCCoreConfigManager.configuration.get(Configuration.CATEGORY_GENERAL, "Enable Sealer Multithreading", true, "If this is enabled, Oxygen Sealers seal checks will run in a separate thread - makes things faster so this should normally be true.").getBoolean(true);
