...
//    private static boolean keepLoadedOffline;
    ...
    public static void loadConfig(File file)
    {
        ...
        try
        {
//            keepLoadedOffline = config.get("CHUNKLOADING", "OfflineKeepLoaded", true, "Set to false if you want each player's chunk loaders to unload when they log out.").getBoolean(true);
    ...
    {
        HashMap<Integer, HashSet<ChunkCoordinates>> dimensionMap = chunkLoaderList.get(playerName);
...
//        {
//            for (Entry<Integer, HashSet<IChunkLoader>> dimEntry : loadedChunks.entrySet())
//            {
//                int dimID = dimEntry.getKey();
//                
//                for (IChunkLoader loader : new ArrayList<IChunkLoader>(dimEntry.getValue()))
//                {
//                    World world = loader.getWorldObj();
//                    
//                    ChunkCoordinates coords = loader.getCoords();
//                    TileEntity tile = world.getBlockTileEntity(coords.posX, coords.posY, coords.posZ);
//                    
//                    if (tile != null && tile.equals(loader))
//                    {
//                        Chunk chunkAt = world.getChunkFromChunkCoords(coords.posX >> 4, coords.posZ >> 4);
...
//                                    {
//                                        HashMap<Integer, HashSet<ChunkCoordinates>> otherDimMap = chunkLoaderList.get(loader.getOwnerName());
//                                        
//                                        if (otherDimMap != null)
//                                        {
...
//                        if (!foundOtherLoader)
//                        {
//                            ForgeChunkManager.unforceChunk(loader.getTicket(), new ChunkCoordIntPair(coords.posX >> 4, coords.posZ >> 4));
...
//                        dimEntry.getValue().remove(loader);
//                        
//                        HashMap<Integer, HashSet<ChunkCoordinates>> dimMap = chunkLoaderList.get(player.username);
//                        
//                        if (dimMap != null)
//                        {
