...
{
    public static final String[] names = { "solar_module_0", "solar_module_1", "ingotCopper", "ingotTin", "ingotAluminum", "ingotSteel", "ingotBronze", "compressedCopper", "compressedTin", "compressedAluminum", "compressedSteel", "compressedBronze" };
