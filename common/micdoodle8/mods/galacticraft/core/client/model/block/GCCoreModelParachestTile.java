...
{
    public NMTModelRenderer keyParts[] = new NMTModelRenderer[3];

    public GCCoreModelParachestTile()
    {
        super();
        this.keyParts[0] = new NMTModelRenderer(this, 0, 1);
        ...
        this.keyParts[1] = new NMTModelRenderer(this, 0, 1);
        ...
        this.keyParts[2] = new NMTModelRenderer(this, 0, 1);
    ...
    public void renderAll(boolean lidUp)
    {
        if (lidUp)
        {
            for (NMTModelRenderer m : this.keyParts)
            {
                m.render(0.0625F);
            }
        }
