...
public class GCCoreFontRendererLarge
{
    ...
    public GCCoreFontRendererLarge(GameSettings par1GameSettings, ResourceLocation par2ResourceLocation, TextureManager par3TextureManager, boolean par4)
    {
