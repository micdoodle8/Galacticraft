...
public class GCCoreRenderItemCustom extends Render
{
	...
	public void doRenderItem(EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
	{
		...
		{
			GL11.glPushMatrix();
			float f2 = this.shouldBob() ? MathHelper.sin((par1EntityItem.age + par9) / 10.0F + par1EntityItem.hoverStart) * 0.1F + 0.1F : 0F;
	...
	private void renderDroppedItem(EntityItem par1EntityItem, Icon par2Icon, int par3, float par4, float par5, float par6, float par7, int pass)
	{
		...
		if (this.renderManager.options.fancyGraphics)
		{
			...
			f11 = 0.021875F;
			ItemStack itemstack = par1EntityItem.getEntityItem();
			byte b0 = this.getMiniItemCount(itemstack);
			...
			for (int k = 0; k < b0; ++k)
			{
				...
				if (itemstack.hasEffect(pass))
				{
					...
					this.renderManager.renderEngine.bindTexture(GCCoreRenderItemCustom.field_110798_h);
	 ...
	 */
	public void renderItemIntoGUI(GCCoreSmallFontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5)
	{
		this.renderItemIntoGUI(par1FontRenderer, par2TextureManager, par3ItemStack, par4, par5, false);
	}

	public void renderItemIntoGUI(GCCoreSmallFontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5, boolean renderEffect)
	{
	...
	private void renderEffect(TextureManager manager, int x, int y)
	{
		...
		manager.bindTexture(GCCoreRenderItemCustom.field_110798_h);
		this.zLevel -= 50.0F;
		GL11.glEnable(GL11.GL_BLEND);
	 ...
	 */
	public void renderItemAndEffectIntoGUI(GCCoreSmallFontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5)
	{
		if (par3ItemStack != null)
		{
			if (!ForgeHooksClient.renderInventoryItem(this.renderBlocks, par2TextureManager, par3ItemStack, this.renderWithColor, this.zLevel, par4, par5))
			{
			 ...
			 * par2TextureManager.bindTexture(field_110798_h); this.zLevel -=
	 ...
	 */
	public void renderItemOverlayIntoGUI(GCCoreSmallFontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5)
	{
		this.renderItemOverlayIntoGUI(par1FontRenderer, par2TextureManager, par3ItemStack, par4, par5, (String) null);
	}

	public void renderItemOverlayIntoGUI(GCCoreSmallFontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5, String par6Str)
	{
		if (par3ItemStack != null)
		{
