...
public class GCCoreEntityRocketT2 extends EntitySpaceshipBase implements IInventory, IMissileLockable, IRocketType
{
    ...
    public void onTeleport(EntityPlayerMP player)
    {
        ...
        player.playerNetServerHandler.sendPacketToPlayer(PacketUtil.createPacket(GalacticraftCore.CHANNEL, 22, new Object[]
        { 0 }));
    ...
    public List<ItemStack> getItemsDropped()
    {
        ...
        items.add(new ItemStack(GCMarsItems.spaceship, 1, this.getSpaceshipType()));
