...
{
    GCCoreEntityRocketT2 spaceship = new GCCoreEntityRocketT2(FMLClientHandler.instance().getClient().theWorld);
    ...
    private void renderPipeItem(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture("/micdoodle8/mods/galacticraft/mars/client/entities/spaceshipTier2.png");
