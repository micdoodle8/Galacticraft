...
public interface IMapObject
{
     ...
     * Used for rendering planet's location on the map.
     * 
     * Value of 1440.0F would result in the planet being rendered directly accross from the original position
     * 
     * Value of 2880.0F is a full rotation and therefore would be rendered at the same spot as the original position
     * 
     ...
     * 
     * Value of 2.0F would result in the planet rotating twice as slow (and therefore take twice as long) as the earth takes to revolve around the sun. 
     * 
