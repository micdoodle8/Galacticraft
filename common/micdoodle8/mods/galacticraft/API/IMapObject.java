...
public interface IMapObject
{
    ...
    /**
     * Get the sinusoidal phase shift (offset from default planet revolution)
     * when rendering the planet on the map.
     * 
    ...
    /**
     * ... AKA the year length in terms of Earth's. (e.g. Mars would return
     * 1.88F, since it has a year of 1.88 times earth's)
     * 
