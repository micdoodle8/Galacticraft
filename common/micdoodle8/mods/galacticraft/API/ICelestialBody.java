...
public interface ICelestialBody
{
    ...
    /**
     * Whether or not this planet/moon should be automatically registered in the forge dimension manager at the appropriate time.
     * 
     * @return false if you're registering dimensions on your own, true for automatic registering
     */
     ...
     * 
     * @return the WorldProvider subclass. Must also implement @IGalacticraftWorldProvider. Return null if planet is not reachable.
     */
     ...
     * 
     * PROTIP: Make this configurable for users since duplicates between mods aren't allowed.
     * 
     * @return the dimension ID to use for this planet. Return -1 if not reachable.
     */
